...
Como resultado de la investigación, los modelos MobileNet y EfficientNet serán propuestos como base para realizar la clasificaión de imágenes. 
...
\captionof{figure}{Exportación del modelo MobileNet}
...
\captionof{figure}{Modificación del modelo Mobilnet}
...
La gráfica muestra el las epocas y la precisión obtenida en cada una de ellas, así como la precisión de los datos ocupados para la validación dentro del entrenamiento. 

MobileNet

\begin{center}
  \includegraphics[scale=0.4]{imagenes/ENgrafico.JPG}
\captionof{figure}{Gráfica de precisión en cada epoca del modelo MobileNet. }
 \label{fig:GraficaEN} 
\end{center} 
...
\captionof{figure}{Gráfica de precisión en cada epoca del modelo EfficientNet.}
 \label{fig:GraficaMN} 
\end{center} 
...
\captionof{figure}{Predicción 1 para del modelo MobileNet. }
 \label{fig:Prueba1} 
\end{center} 

\begin{center}
  \includegraphics[scale=0.4]{imagenes/ojo_abiertoEN.JPG}
\captionof{figure}{Predicción 2 para del modelo MobileNet. }
 \label{fig:Prueb2} 
\end{center} 
...
\captionof{figure}{Predicción 1 para del modelo EfficientNet.}
 \label{fig:Prueba3} 
\end{center} 

\begin{center}
  \includegraphics[scale=0.4]{imagenes/ojo_abiertoMN.JPG}
\captionof{figure}{Predicción 2 para del modelo EfficientNet.}
 \label{fig:Prueba4} 
\end{center} 
...
\bibitem{TLe}M. Arroyo, "¿Qué es el Transfer Learning?," Data Scientist, 2019. [Online]. Available: \url{ https://datascientest.com/es/que-es-el-transfer-learning#:~:text=%E2%80%9CEl%20Transfer%20Learning%2C%20o%20aprendizaje,el%20crecimiento%20del%20Deep%20Learning. }[Accessed: 13-Mar-2023].
