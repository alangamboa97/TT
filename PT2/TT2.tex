...
\subsubsection{Prueba de Detección de Somnolencia en Condiciones Normales}
 
 \begin{itemize}
 \item Detectar el estado "activo" cuando el conductor se encuentre despierto.
 
 \item Detectar un estado "somnoliento" cuando el conductor presente signos de somnolencia debido al parpadeo de ojos poco significativos.  
 
 \item Detectar un estado "somnoliento" en la que el conductor presente signos de somnolencia debido a los bostezos frecuentes. 
 
 \item Detectar un estado "dormido" cuando el conductor presente signos de somnolencia debido al cierre de los ojos por más de 2 segundos.  
...
\subsection{Evaluación del Sistema Final}

\subsubsection{Prueba de Funcionalidad Integral:}
\begin{itemize}
  \item Prueba del sistema para validar su funcionalidad global en condiciones simuladas y reales.
\end{itemize}

\subsubsection{Prueba de Resiliencia del Sistema:}
\begin{itemize}
  \item Evaluar la capacidad del sistema para recuperarse de posibles fallas o interrupciones en los servicios y módulos.
\end{itemize}

\subsubsection{Prueba de Seguridad Integral:}
\begin{itemize}
  \item Realizar análisis de seguridad para identificar posibles vulnerabilidades en la comunicación, autenticación y almacenamiento de datos. 
\end{itemize}

\subsubsection{Prueba de Usabilidad:}
\begin{itemize}
  \item Obtener retroalimentación sobre la experiencia del usuario en la aplicación web y la interacción con las alertas.
\end{itemize}




%\item Confirma que la información sea precisa y esté formateada correctamente.
%\item Reproduce el video y asegúrate de que la reproducción sea fluida y sin problemas.
 ...
 Pruebas dentro de un vehiculo y el uso de lentes. 
...
La validación implica confirmar que el sistema cumple con los requisitos y expectativas establecidos.  La validación asegura que el sistema funcione correctamente y cumpla con su propósito previsto.
...
Validación:
Validación con Datos Reales de Somnolencia

Acción: Comparar las lecturas del módulo con registros de personas que han demostrado signos evidentes de somnolencia.
Resultado Esperado: El módulo detecta y refleja correctamente la somnolencia.

Verificar la precisión de la detección de síntomas de somnolencia utilizando conjuntos de datos variados que representen diferentes niveles de somnolencia.
Evaluar la capacidad del sistema para alertar al conductor de manera efectiva ante la detección de somnolencia.
Realizar pruebas en condiciones de iluminación variadas para confirmar la robustez del sistema.
Geolocalización en Tiempo Real:

Comprobar la actualización constante y precisa de la ubicación del conductor durante su desplazamiento.
Validar la capacidad del sistema para obtener señales de redes móviles y proporcionar la ubicación en entornos urbanos y rurales.
Verificar la consistencia en la precisión de la geolocalización en diferentes momentos y condiciones.
Sistema de Administración:


Desde la aplicación, se puede visualizar el mapa con un marcador de posicionamiento GPS en tiempo real. Se probó con un vehículo en movimiento en la Avenida Villa Panamericana, donde podemos observar su desplazamiento en las siguientes figuras:
...
Evaluar la eficacia del sistema de administración en la gestión de usuarios, incluyendo la creación, modificación y eliminación de perfiles.
Verificar la capacidad de almacenamiento de datos, asegurándote de que la información se guarde correctamente y esté disponible cuando se requiera.
Realizar pruebas de consultas de incidencias para confirmar la accesibilidad y la precisión de los datos almacenados.
Comunicaciones entre Sistemas:

Validar la comunicación eficiente y sin errores entre el sistema de visión artificial y el sistema de administración.
Comprobar la transmisión precisa de datos relevantes, como alertas de somnolencia y ubicación del conductor.
Evaluar la respuesta del sistema ante posibles interrupciones o fallos en la comunicación.

\subsubsection{Resultados}

\subsection{Resultados y Ajustes:}
\begin{itemize}
  \item Evaluar los resultados de cada prueba y realizar ajustes en el diseño o implementación según sea necesario.
  \item Utilizar los resultados como base para iteraciones adicionales en el desarrollo, siguiendo el enfoque de la metodología en espiral.
\end{itemize}

Resultados:

Precisión en la Detección de Somnolencia: Analiza los resultados de las pruebas de detección de somnolencia para evaluar la precisión del sistema en la identificación de síntomas.
Funcionalidad de Geolocalización: Examina la precisión y la actualización en tiempo real de la geolocalización durante las pruebas.
Operación del Sistema de Administración: Evalúa la funcionalidad y eficacia del sistema de administración, asegurándote de que cumpla con los objetivos establecidos.
Comunicación entre Sistemas: Verifica que la comunicación entre el sistema de visión artificial y el sistema de administración sea efectiva y sin problemas.
...
Los resultados son las salidas o conclusiones derivadas de las pruebas y validación. Los resultados indican el rendimiento y la eficacia del sistema en la detección de somnolencia.
...
Análisis de Datos de Conducción a Largo Plazo:

Implementar un sistema de análisis de datos a largo plazo que registre y analice patrones de somnolencia a lo largo del tiempo. Esto podría ayudar a los conductores y a las empresas de transporte a identificar tendencias y tomar medidas preventivas.

Personalización de Alertas Acústicas:

Ampliar la variedad de sonidos de alerta disponibles y permitir a los usuarios personalizar la alarma según sus preferencias. Esto puede incluir sonidos suaves, tonos personalizados o incluso mensajes de voz.

Mejora de Algoritmos de Redes Neuronales:

Continuar refinando y entrenando los algoritmos de redes neuronales para la detección de somnolencia. La inclusión de conjuntos de datos más grandes y diversos puede mejorar la precisión del modelo.

Gestión de Flotas en Tiempo Real:

Si la aplicación se utiliza en flotas de vehículos, incorporar una función de gestión de flotas en tiempo real. Permite a los supervisores rastrear la somnolencia de varios conductores simultáneamente, facilitando la toma de decisiones coordinadas.

Zonas de Riesgo Personalizadas:

Implementar la capacidad de que los usuarios definan zonas geográficas específicas como "zonas de riesgo" donde la probabilidad de somnolencia puede ser mayor. La aplicación web puede proporcionar alertas y sugerencias específicas para estas áreas.

Capacitación en Seguridad Vial:

Ofrecer módulos de capacitación en seguridad vial directamente a través de la aplicación web. Esto podría incluir consejos sobre cómo combatir la fatiga, la importancia de los descansos y las mejores prácticas para mantenerse alerta al conducir.
