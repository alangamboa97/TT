...
\begin{itemize}
  ...
  \item En base al promedio de la duración de un bostezo, que es entre 5 y 10 segundos\cite{teive2018}, se definió un umbral de 5 segundos de duración de apertura de boca para considerarse como un bostezo.
