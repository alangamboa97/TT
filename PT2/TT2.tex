...
Verificar la precisión de la detección de síntomas de somnolencia 
...
Comprobar la transmisión precisa de la ubicación del conductor.
Evaluar la respuesta del sistema ante posibles interrupciones o fallos en la comunicación.

\subsubsection{Resultados}

El módulo detecta y refleja correctamente la somnolencia.
