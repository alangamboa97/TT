...
Después de haber iniciado la Jetson Nano, se abrió una terminal y se ingresaron los siguientes comandos:
...
\begin{enumerate}
\item Requiere instalar Python 3
\begin{verbatim}
sudo apt install python3-pip
\end{verbatim}

\item Instalar Jetson Stats
\begin{verbatim}
sudo pip3 install -U jetson-stats
\end{verbatim}

\item Una vez instalado se debe reiniciar la maquina
\begin{verbatim}
sudo reboot
\end{verbatim}

\item Una vez reiniciado se puede hacer uso del comando jtop
\begin{verbatim}
jtop
\end{verbatim}
\end{enumerate}
...
\begin{center}
  \includegraphics[scale=0.2]{imagenes/Jtop.jpeg}
\captionof{figure}{Interfaz despues de la intación de Jetson Stats.}
 \label{fig:Jtop} 
\end{center}  
...
\bibitem{JetPackSDK} nvidia. (s.f.). JetPack SDK 4.6.3. NVIDIA Developer. https://developer.nvidia.com/jetpack-sdk-463

\bibitem{JetStats} Kangalow. (2023, 7 de febrero). Jtop: The ultimate tool for monitoring NVIDIA jetson devices - jetsonhacks. JetsonHacks. https://jetsonhacks.com/2023/02/07/jtop-the-ultimate-tool-for-monitoring-nvidia-jetson-devices/ 
