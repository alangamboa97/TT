...
Moderación de contenido: Automatización de la eliminación de material inseguro o inapropiado en archivos visuales, como imágenes y videos.

Reconocimiento facial: Identificación de rostros y reconocimiento de características faciales como la apertura de los ojos, la presencia de gafas y la existencia de vello facial.

Clasificación de imágenes: Identificación de elementos específicos en una imagen, como logotipos de marcas, prendas de vestir, equipo de seguridad y otros detalles visuales \cite{AP}.
...
Una aplicación web se define como un software que se ejecuta en un navegador web, permitiendo a las empresas llevar a cabo el intercambio de información y proporcionar servicios de manera remota. Dichas aplicaciones son empleadas por las organizaciones para establecer comunicación con sus clientes de manera segura y bajo demanda. Aspectos fundamentales de los sitios web, como carros de compra, funciones de búsqueda y filtrado de productos, mensajería instantánea y canales de noticias en redes sociales, comparten el mismo diseño que las aplicaciones web. Estas herramientas posibilitan el acceso a funciones complejas sin la necesidad de instalar o configurar un software adicional.

Las aplicaciones web se estructuran en una arquitectura cliente-servidor, dividiendo su código en dos componentes principales: scripts del lado del cliente y scripts del lado del servidor.

En la arquitectura del lado del cliente, el script se encarga de la interfaz de usuario, gestionando elementos visuales como botones y menús desplegables. Al acceder a la aplicación web, el navegador carga este script, permitiendo la visualización de elementos gráficos y texto para la interacción del usuario, como leer contenidos, ver videos o completar formularios. Las acciones del usuario generan solicitudes al servidor.

En la arquitectura del lado del servidor, el script se encarga del procesamiento de datos. El servidor procesa las solicitudes del cliente y envía respuestas correspondientes, como obtener, editar o almacenar datos. Por ejemplo, al hacer clic en "Leer más", el servidor envía contenido adicional, mientras que al hacer clic en "Enviar", guarda los datos del usuario en la base de datos. En algunas instancias, el servidor completa la solicitud enviando la página HTML completa al cliente, un proceso conocido como renderizado del lado del servidor \cite{aplicacionWeb}.
...
\begin{enumerate}
\item Presente proyecto propuesto
...
\begin{center}
  \includegraphics[scale=.5]{imagenes/DiagramaFlujo_Vision.png}
...
\begin{center}
  \includegraphics[scale=0.5]{imagenes/Prueba-AlarmaConsola.jpeg}
...
\begin{center}
  \includegraphics[scale=0.5]{imagenes/Prueba-AlarmaEnJN.jpeg}
...
\begin{itemize}
    ...
    \item Ingresa credenciales válidas y asegúrate de que se permita el acceso.
       ...
       \begin{center}
        \includegraphics[scale=.3]{imagenes/Prueba-login.jpeg} 
...
\begin{itemize}
    \item Confirmar que el formulario de registro es accesible.
      ...
      \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-formulario0.JPG}
    ...
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-formulario1.jpeg}
    ...
    \item Enviar el codigo de registro al correo proporcionado.
      ...
      \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-formulario2.jpeg}
...
\begin{itemize}
    ...
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-RecuperarContrasena.jpeg}
    ...
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-RecuperarContrasenaFormulario.jpeg}
    ...
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-verificarCodigo.jpeg}
...
\begin{itemize}
 ...
 \begin{center}
  \includegraphics[scale=0.9]{imagenes/Validacion-SistemaVistaFrontal.jpeg}
	\captionof{figure}{Vista lateral del sistema.}
  \label{fig:addstorage} 
  \end{center}   
  
  \begin{center}
  \includegraphics[scale=0.9]{imagenes/Validacion-SistemaVistaLateral.jpeg}
...
Se encendio el sistema y ejecutamos el archivo diseñado para la detección de somnolencia. El sistema capturó imágenes en tiempo real y evaluamos su capacidad para detectar correctamente el estado activo cuando el conductor estaba despierto, así como el estado somnoliento al manifestar signos como el cierre de ojos o bostezos constantes. En caso de detectar somnolencia, el sistema activa una alerta y envía la incidencia al sistema de administración.
 ...
 \begin{center}
  \includegraphics[scale=0.9]{imagenes/Validacion-EstadoActivo.png}
	\captionof{figure}{Estado activo del conductor.}
  \label{fig:addstorage} 
  \end{center}   
...
\begin{center}
  \includegraphics[scale=0.9]{imagenes/Validacion-AccesoSistema.JPG}
...
\item Incidencia recibida y accedida desde la aplicación.
  ...
  \begin{center}
  \includegraphics[scale=0.9]{imagenes/Validacion-IncidenciaVistaApp1.JPG}
...
\item Incidencia recibida y accedida desde la aplicación.
  ...
  \begin{center}
  \includegraphics[scale=0.9]{imagenes/Validacion-IncidenciaVistaApp2.JPG}
	\captionof{figure}{Vista de incidencia desde la aplicación web.}
  \label{fig:addstorage} 
  \end{center}
...
Desde la aplicación, se visualizó el mapa con un marcador de posicionamiento GPS en tiempo real. Se probó con un vehículo en movimiento en la Avenida Villa Panamericana, donde se puede observar su desplazamiento en las siguientes figuras:
  ...
  \begin{center}
  \includegraphics[scale=0.6]{imagenes/posicion1.png}
	\captionof{figure}{Mapa y marcador de posicionamiento GPS en tiempo real 1.}
  \label{fig:addstorage} 
  \end{center} 

  \begin{center}
  \includegraphics[scale=0.6]{imagenes/posicion2.png}
...
\item Optimización Continua de Algoritmos de Redes Neuronales:

Se plantea la implementación y el entrenamiento de algoritmos de redes neuronales para la detección de somnolencia. La incorporación de conjuntos de datos más extensos y diversos tiene el potencial de elevar la precisión del modelo, fortaleciendo así la eficacia del sistema.
