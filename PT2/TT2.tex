...
\begin{itemize}
 ...
 \item Pruebas de estados de apertura y cierre de ojos y boca para la detección de somnolencia en diferentes condiciones de iluminación: 
 \begin{itemize}
 \item Detectar un estado "activo" en la que el conductor se encuentre despierto.
 
 \item Detectar un estado "somnoliento" en la que el conductor presente signos de somnolencia debido al cierre de los ojos por más de 2 segundos. 
 ...
 \item Prubas dentro de un vehiculo y el uso de lentes. 
...
\subsubsection{Prueba de Integración con GitHub:}
\begin{itemize}
  
  \item Probar el despliegue de la aplicación ingresando con la URL.
...
\subsubsection{Gestión de Contenido Multimedia y Seguridad}

\subsubsection{Prueba de Almacenamiento en S3:}
\begin{itemize}
  \item Prueba de acceso al almacenamiento en la nube S3 para contenido multimedia al subir un video grabado debido a la detección de somnolencia.
  
  \item Prueba de disponibilidad y confiabilidad de los archivos almacenados desde la aplicación.
  
\end{itemize}

\subsubsection{Prueba de Autenticación y Gestión de Identidades (Amazon Cognito):}
\begin{itemize}
  \item Prueba de registro de usuario.
 ...
 \end{center} 
  ...
  \item Prueba de autenticación y acceso a la aplicación web.
 ...
 \end{center} 
  ...
  \item Prueba de recuperación de contraseña del usuario.
  \item Prueba de eliminación de usuario.

\end{itemize}

\subsubsection{Aplicación Web (Amplify y React)}

\subsubsection{Prueba de Rendimiento del Backend:}
\begin{itemize}
  \item Evaluar la capacidad de respuesta y eficiencia del backend.
  \item Verificar la gestión adecuada de las solicitudes concurrentes.
\end{itemize}

\subsubsection{Prueba de Interfaz de Usuario (Frontend React):}
\begin{itemize}
  \item Prueba de visualización de usuarios
  \item Prueba de visualización de incidencias 
  \item Prueba de visualización de incidencias por mes  
  \item Prueba de modificación de usuario 
  \item Prueba de confirmacion de incidencia 
  \item Prueba de modificación de usuario  
\end{itemize}
...
\begin{itemize}
  \item Prueba de conexión LTE para la transferencia de información.
