...
\fancyfoot[R]{\thepage}
\fancyfoot[L]{\footnotesize Proyecto Terminal II}
...
Quiero expresar mi agradecimiento a mi familia, quienes han sido mi apoyo incondicional a lo largo de este proyecto. Su amor, paciencia y aliento constante han sido la fuerza impulsora que me ha permitido llegar hasta este punto.

Agradezco a mis asesores, M. en C. Niels Henrik Navarrete Manzanilla y Dr. Rodolfo Vera Amaro, por su orientación, apoyo y su valioso tiempo dedicado a revisar y mejorar el presente trabajo. Su sabiduría y experiencia han sido fundamentales para el desarrollo del proyecto.

Agradezco principalmente el apoyo invaluable de mi compañero de trabajo Alan Gamboa, quien ha compartido conmigo tanto los desafíos como los éxitos. Sus ideas, discusiones y colaboraciones han enriquecido significativamente el trabajo.

Finalmente, dedico este trabajo a aquellos que creyeron en mí desde el principio y a todos los que han contribuido de diversas maneras a mi crecimiento académico y personal.

\begin{flushright}
\textbf{Maite Paulette Díaz Martínez}
\end{flushright}



A Eduardo y Eneida, su amor, aliento y sacrificios han sido la fuerza impulsora que me ha permitido llegar hasta este momento. Gracias por ser mis guías, por creer en mí cuando dudaba y por ser la base sólida sobre la cual construí este logro.\\

A Carlos y María Luisa, no puedo dejar de reconocer el papel crucial que han desempeñado en mi vida. Su amor y orientación han sido un regalo invaluable. Gracias por ser una extensión de mi familia, por compartir sabiduría y por contribuir a mi crecimiento personal y académico. Su influencia ha dejado una marca imborrable en mi corazón.\\

A mis asesores el Dr. Rodolfo y el M.en C. Niels, quiero expresar mi gratitud por su dedicación y orientación a lo largo de este arduo pero gratificante viaje. Su experiencia, paciencia y compromiso han sido fundamentales para mi desarrollo académico. Gracias por brindarme su tiempo, conocimientos y por inspirarme a alcanzar estándares más altos. Este logro también es suyo.\\

A Maite Díaz, compartir este trayecto contigo ha sido un privilegio. Tus ideas, colaboración y apoyo han enriquecido enormemente mi experiencia personal y académica. Aprecio sinceramente la dedicación y el esfuerzo que has aportado a este proyecto. Juntos hemos superado desafíos y celebrado triunfos, y estoy agradecido por tener a alguien tan talentosa y comprometida a mi lado.

\begin{flushright}
\textbf{Alan Eduardo Gamboa Del Ángel}
\end{flushright}




% Agrega aquí tus agradecimientos
\newpage
\tableofcontents
\newpage
\listoffigures
...
El sistema propuesto para la detección de somnolencia en conductores utiliza técnicas de visión artificial para analizar en tiempo real la detección del rostro, ojos y boca a través de un flujo de video. Se clasifican los estados de los ojos y la boca para identificar síntomas de somnolencia mediante puntos de referencia faciales. La medición de la relación de apertura en los ojos y la boca se realiza mediante el seguimiento de parpadeos y bostezos. En caso de detectar somnolencia, el sistema activa una alarma y genera un informe de incidencia enviado a una base de datos en DynamoDB. Se emplea una Jetson Nano para la portabilidad del sistema. A su vez, se ha desarrollado una aplicación web que ofrece el monitoreo en tiempo real de la ubicación del conductor, además de proporcionar un sistema de administración que permite a los usuarios acceder y visualizar la información de los informes de incidencia, así como detalles específicos de cada conductor. Para el desarrollo del sistema se eligió la metodología en espiral debido a su naturaleza iterativa y flexible.
\\

\emph{\textbf{Palabras Clave:}} Somnolencia, Visión Artificial, Geolocalización en Tiempo Real, Alerta, Aplicación web, Sistema de Administración.

\section{Abstract}

The proposed system for detecting drowsiness in drivers utilizes artificial vision techniques to analyze real-time detection of the face, eyes, and mouth through a video stream. The states of the eyes and mouth are classified to identify drowsiness symptoms using facial landmarks. Measurement of the opening ratio in the eyes and mouth is carried out through the tracking of blinks and yawns. In the event of detecting drowsiness, the system activates an alarm and generates an incident report sent to a DynamoDB database. A Jetson Nano is employed for system portability. Additionally, a web application has been developed, providing real-time monitoring of the driver's location, along with an administration system that allows users to access and visualize information from incident reports, as well as specific details for each driver. The spiral methodology was chosen for the system development due to its iterative and flexible nature.\\

\emph{\textbf{Keywords:} Drowsiness, Artificial Vision, Real-time Geolocation, Alert, Web Application, Management System.} 
...
Hoy en día, se están comenzando a utilizar tecnologías para prevenir y detectar síntomas de fatiga y somnolencia en conductores. Uno de estos métodos está basado en el comportamiento del vehículo, el cual detecta el estado del conductor mediante el análisis de distintas métricas como son: movimientos del volante, posición del vehículo, presión del acelerador o del freno, cambio de velocidades, con los cuales se determina la posibilidad de que el conductor se encuentre en estado de somnolencia. El principal problema de dicho método es que las características individuales del vehículo, del conductor y de la carretera repercuten en la eficacia del sistema.Por otra parte, se encuentran los métodos que se basan en el análisis de variables fisiológicas, los cuales permiten la detección de somnolencia en sus fases tempranas con una baja tasa de falsos positivos. Entre los métodos, el EEG es el más común para la detección de la somnolencia, donde se analizan diferentes bandas de frecuencia. Todas estas señales brindan información adicional al momento de analizar el estado de somnolencia de una persona. Sin embargo, estos métodos requieren contacto con el conductor y el uso excesivo de canales de encefalogramas, lo cual resta comodidad, y practicidad al conductor, además de llegar a ser invasivos, lo cual puede entorpecer el desempeño del conductor. Finalmente, se encuentra el análisis de características visuales que puede presentar un conductor somnoliento, como los movimientos faciales, parpadeos rápidos y constantes, cabeceos y bostezos frecuentes. Sin embargo, los bostezos se presentan generalmente antes de que el conductor entre en somnolencia, mientras que los cabeceos normalmente ocurren cuando el conductor se duerme. Estos métodos no son capaces de detectar con exactitud cuando un conductor está empezando a entrar en un estado de somnolencia. Se debe tomar en cuenta las diferencias temporales entre los distintos signos visuales, por lo que realizar la combinación de varias de estas características aumentará la robustez final del sistema, logrando una mejor eficiencia \cite{Sisdesomnolencia}.
\\

Actualmente existen distintas opciones para la geolocalización de vehículos en tiempo real, pero con costos elevados, como lo es el rastreo satelital, el cual requiere un pago por servicio con una suscripción anual o mensual. Entonces, surge una oportunidad para desarrollar soluciones más asequibles \cite{GeolocalizacionVehiculos}.
\\
...
\item En la figura \ref{fig:Arquitecturapreliminar} se muestra la propuesta del diagrama general de diseño de la arquitectura del sistema.
\end{itemize}

\begin{center}
  \includegraphics[scale=0.9]{imagenes/diagramageneral2}
\captionof{figure}{Arquitectura general del sistema.}
...
\item Integrar herramientas de geolocalización en tiempo real usando redes de telecomunicaciones móviles.
...
El artículo de Barry Boehm \cite{metodolo}, publicado en 1986, introduce la Metodología Espiral como un enfoque para el desarrollo de software que combina elementos de modelos de desarrollo en cascada y prototipos. La metodología espiral se destaca por su enfoque flexible y adaptativo, permitiendo ajustes a lo largo del ciclo de desarrollo.
\\
...
\begin{center}
  \includegraphics[scale=0.9]{imagenes/momdelo-espiral.JPG}
\captionof{figure}{Modelo espiral del proceso de software \cite{metodolo}.}
 \label{fig:JetsonNano} 
\end{center} 

De manera general el proyecto se dividió en tres principales módulos los cuales pasarón por las cuatro fases de la metodología. En la primera fase se especificaron los objetivos particulares de cada módulo, posteriormente se propuso un prototipo a partir de la elección de los componentes y algoritmos de cada módulo, en la tercera fase se implementaron los modelos propuestos y finalmente en la última fase se revisaron los resultados. A partir de los resultados obtenidos se realizarón los ajustes necesarios para cumplir el objetivo principal y los objetivos específicos. Los puntos anteriores se desglozan a lo largo del siguiente documento. 

\subsection{Escenario de pruebas}

De acuerdo a los objetivos especificos se evaluaran los isguientes puntos: 

\begin{itemize}
\item El sistema de visión artificial debe ser capaz de detectar somnolencia.
\item Alertar al conductor en caso de detectar incidencias.
\item Elaboración de incidencias.
\item Conexión entre el sistema de visión artificial y el sistema de administración.
\item Visualización en tiempo real de la ubicación GPS del conductor usando redes de telecomunicaciones móviles.
...
\begin{itemize}
\item Detección del rostro del conductor.
\item Clasificación de la somnolencia basada en el estado de los ojos y su duración.
\item Clasificación de la somnolencia basada en el número de bostezos por minuto.
\end{itemize}
...
\\
Para el sistema de administración, se probará la aplicación web que incluye el acceso al sistema, la geolocalización del conductor en tiempo real, la visualización de las incidencias y la información del conductor disponible.
\\
...
Jetson Nano es una computadora compacta y potente diseñada para ejecutar simultáneamente varias redes neuronales. Esta versátil plataforma se utiliza en aplicaciones como la clasificación de imágenes, la detección de objetos, la segmentación y el procesamiento de voz. Destaca por ser fácil de usar y opera con una eficiencia energética de 5 vatios \cite{jetsonN}.

\begin{center}
  \includegraphics[scale=0.4]{imagenes/JetsonNano}
\captionof{figure}{Kit para Desarrolladores Jetson Nano \cite{jetsonN}. }
 \label{fig:JetsonNano} 
\end{center} 
...
La visión artificial se encuentra dentro del ámbito de la inteligencia artificial y se dedica a entrenar sistemas computacionales para extraer información valiosa de imágenes digitales y videos, con el objetivo de tomar decisiones o hacer recomendaciones. La efectividad de la visión artificial depende en gran medida de la disponibilidad de datos abundantes. A través de análisis de datos iterativos, este campo realiza comparaciones repetidas hasta identificar discrepancias y, en última instancia, reconocer patrones visuales en las imágenes \cite{IBMvision}.

La visión artificial se define como la capacidad de los sistemas computacionales para analizar e interpretar información relevante a partir de imágenes y videos. Utilizando técnicas de aprendizaje profundo, las computadoras pueden procesar las imágenes de manera similar a la capacidad humana. Este campo de estudio presenta diversas aplicaciones prácticas, entre las cuales se encuentran:
\begin{itemize}
\item Moderación de contenido: Automatización de la eliminación de material inseguro o inapropiado en archivos visuales, como imágenes y videos.
\item  Reconocimiento facial: Identificación de rostros y reconocimiento de características faciales como la apertura de los ojos, la presencia de gafas y la existencia de vello facial.
\item Clasificación de imágenes: Identificación de elementos específicos en una imagen, como logotipos de marcas, prendas de vestir, equipo de seguridad y otros detalles visuales \cite{AP}.
\end{itemize}
...
El aprendizaje profundo constituye un enfoque dentro del ámbito de la inteligencia artificial (IA) que busca capacitar a las computadoras para procesar información de manera análoga al cerebro humano.  Los modelos de aprendizaje profundo son capaces de reconocer patrones complejos en imágenes, textos, sonidos y otros datos, a fin de generar información y predicciones precisas. Es posible utilizar métodos de aprendizaje profundo para automatizar tareas que habitualmente requieren inteligencia humana, como la descripción de imágenes o la transcripción a texto de un archivo de sonido. Los modelos de aprendizaje profundo son archivos informáticos que los científicos de datos han entrenado para realizar tareas específicas mediante un algoritmo o conjunto predefinido de pasos. Estas herramientas son empleadas por empresas para analizar datos y realizar predicciones en diversas aplicaciones \cite{AP}.
%\subsubsection{MOR}

%\subsubsection{EOR} 
\subsubsection{Lenguaje de programación}

Un lenguaje de programación es una herramienta que permite desarrollar software o programas para computadora. Los lenguajes de programación son empleados para diseñar e implementar programas encargados de definir y administrar el comportamiento de los dispositivos físicos y lógicos de una computadora. Lo anterior se logra mediante la creación e implementación de algoritmos de precisión que se utilizan como una forma de comunicación humana con la computadora. Un lenguaje de programación se conforma de una serie de símbolos y reglas de sintaxis y semántica que definen la estructura principal del lenguaje y le dan un significado a sus elementos y expresiones \cite{lenprogram}. 

\subsubsection{Librerías}

Las librerías de programación son recursos que facilitan el proceso de desarrollo de software al ofrecer bloques de código reutilizables. Estos fragmentos de código permiten a los desarrolladores escribir programas de manera más rápida y sencilla, evitando la necesidad de construir cada funcionalidad desde cero. Cada librería está diseñada para proporcionar una solución a una necesidad o un problema de desarrollo específico, barcando áreas como autenticación de usuario, conexión al servidor, interfaces de usuario, gestión de datos, algoritmos, animaciones, entre otros \cite{libreria}.
\subsubsection{Aplicación web}

Una aplicación web se define como un software que se ejecuta en un navegador web, permitiendo a las empresas llevar a cabo el intercambio de información y proporcionar servicios de manera remota. Dichas aplicaciones son empleadas por las organizaciones para establecer comunicación con sus clientes de manera segura y bajo demanda. Aspectos fundamentales de los sitios web, como carros de compra, funciones de búsqueda y filtrado de productos, mensajería instantánea y canales de noticias en redes sociales, comparten el mismo diseño que las aplicaciones web. Estas herramientas posibilitan el acceso a funciones complejas sin la necesidad de instalar o configurar un software adicional. Las aplicaciones web se estructuran en una arquitectura cliente-servidor, dividiendo su código en dos componentes principales: scripts del lado del cliente y scripts del lado del servidor \cite{aplicacionWeb}.

\subsubsection{\emph{Front end}}

El \emph{front end} constituye la parte visible para los usuarios e incluye elementos visuales como botones, casillas de verificación, gráficos y mensajes de texto, facilitando la interacción con la aplicación. Este término se refiere a la interfaz gráfica de usuario (GUI), que permite la interacción directa con elementos como menús de navegación, diseño, botones, imágenes y gráficos. En un contexto técnico, se utiliza el concepto de modelo de objetos del documento (DOM) para describir una página o pantalla que presenta diversos componentes de la interfaz de usuario.

Existen tres lenguajes de programación fundamentales que afectan la forma en que los usuarios interactúan con el \emph{front end}:

\begin{itemize}
\item HTML (Lenguaje de Marcado de Hipertexto): Define la estructura del \emph{front end} y los diferentes elementos del DOM.
\item CSS (Hojas de Estilo en Cascada): Define el estilo de la aplicación web, abarcando aspectos como diseño, fuentes, colores y estilo visual.
\item JavaScript: Introduce una capa de funcionalidad dinámica mediante la manipulación del DOM. JavaScript posibilita cambios en una página y la presentación de nueva información, permitiendo al \emph{front end} gestionar interacciones cruciales de los usuarios, como la visualización de un calendario o la validación de direcciones de correo electrónico. Las solicitudes más complejas se trasladan al \emph{back end} \cite{frontBack}.
\end{itemize}


\subsubsection{\emph{Back end}}
El \emph{back end} engloba los datos y la infraestructura necesarios para el funcionamiento de la aplicación, encargándose del almacenamiento y procesamiento de datos para los usuarios.

La gestión de la funcionalidad general de la aplicación web recae en el \emph{back end}. Cuando el usuario interactúa con el \emph{front end}, dicha interacción envía una solicitud al \emph{back end} en formato HTTP, y este último procesa la solicitud, devolviendo una respuesta.

En el procesamiento de una solicitud, el \emph{back end} típicamente interactúa con los siguientes elementos:

\begin{itemize}
\item Servidores de bases de datos para recuperar o modificar datos relevantes.
\item Microservicios que ejecutan un subconjunto de las tareas solicitadas por el usuario.
\item API de terceros para obtener información adicional o realizar funciones adicionales.
\end{itemize}

Para completar una solicitud, el \emph{back end} utiliza diversos protocolos y tecnologías de comunicación, gestionando simultáneamente miles de solicitudes. El \emph{back end} combina técnicas de concurrencia y paralelismo, como la distribución de solicitudes en muchos servidores, el almacenamiento en caché y la duplicación de datos \cite{frontBack}.

\subsubsection{Web hosting}

El servicio de hosting web consiste en proporcionar almacenamiento para los archivos y datos de un sitio web, junto con la infraestructura necesaria para que sea accesible en Internet. Los proveedores de hosting ofrecen diversas opciones con costos variables, determinados por factores como el espacio de almacenamiento asignado, la capacidad informática, la compartición de recursos con otros sitios, las características adicionales (como el correo con el nombre de dominio o funciones de blogs), el nivel de control y flexibilidad proporcionado al usuario, y la gestión del sitio web, ya sea por el usuario o el proveedor de servicios. En resumen, el costo del hosting web se ajusta según las necesidades y preferencias del usuario en términos de recursos, funcionalidades, control y gestión \cite{webhosting}.
...
\item Transmisión de audio y vídeo. LTE tiene velocidades de descarga y carga más rápidas que 2G y 3G.

\item Conexión a servicios en tiempo real. Con voz sobre LTE, los usuarios pueden hablar con otras personas sin experimentar retrasos ni fluctuaciones.

\item Velocidades aún más rápidas con LTE-Advanced. Las velocidades de descarga y carga con LTE-Advanced son dos o tres veces más rápidas que las de LTE estándar. Todos los dispositivos LTE Advanced son compatibles con versiones anteriores del estándar LTE.

\item Agregación de operadores. Esta función LTE-Advanced mejoró la capacidad de la red, agregando ancho de banda de hasta 100 MHz en cinco operadores (bandas) componentes con un ancho de banda de 20 MHz cada uno. Los teléfonos LTE-A combinan frecuencias de múltiples operadores de componentes para mejorar la señal, la velocidad y la confiabilidad.
...
Este trabajo de investigación propone un sistema de detección de signos de somnolencia en conductores utilizando un modelo de Red Neuronal Convolucional para detectar la posición de los ojos, y OpenCV junto con Dlib para la detección de la boca y realizar el conteo del número de 
s por minuto. Para alimetnar a la red Neuronal, se utilizaron el conjunto de datos de NTHU-DDD. También fue utilizado el método PERCLOS para obtener el número de parpadeos del sujeto de estudio. Este trabajo concluye que las mayores dificultades a la hora de detección de rostros fueron el uso de gafas oscuras, así como cambios en la iluminación \cite{EstadodelAarte1}.
...
\begin{table}[htbp]
    \centering
    \begin{tabular}{|p{0.15\linewidth}|p{0.17\linewidth}|p{0.12\linewidth}|p{0.2\linewidth}|p{0.18\linewidth}|}
        \hline
        \textbf{Proyecto} & \textbf{Detección de somnolencia} & \textbf{Sistema Portátil}  & \textbf{Monitoreo GPS en tiempo real} & \textbf{Sistema de admnistración} \\ \hline
        1 & Sí & Sí& Sí & Sí \\ \hline
        2 & sí & No & No & No \\ \hline
        3 & sí & No & No & No \\ \hline
        4 & sí & No & No & No \\ \hline
        ...
        8 & No & Sí & No & No \\ \hline
        9 & No & Sí & No & No \\ \hline 
        10 & Sí & No & No & No \\ \hline
        11 & Sí & No & No & No \\ \hline
        12 & Sí & Sí & No & No \\ \hline
        13 & Sí & No & No & No \\ \hline
        14 & Sí & No & No & No \\ \hline
        15 & Sí & Sí & No & No \\ \hline
        16 & Sí & No & No & No \\ \hline
        17 & No & Sí & Sí & No \\ \hline
        18 & Sí & No & No & No \\ \hline
        19 & Sí & No & No & No \\ \hline
  \end{tabular}
    \captionof{table}{Comparación entre proyectos y/o sistemas con semanjanza.}
\end{table}
       
\begin{enumerate}
\item Proyecto propuesto
\item Driver Drowsiness Detection Using Machine Learning with Visual Behaviour
\item Detection Of Drowsiness And Distraction Of Drivers Using CNN 
\item Driver Drowsiness Detection System Using Convolutional Neural Networks
\item Rasperry Pi based System for Visual Object Detection and Tracking
\item Diseño e implementación de sistema de visión artificial para alerta y detección de somnolencia mediante aprendizaje profundo aplicable en conductores de vehículos
\item Aplicación de visión por computador y machine learning al guiado de un robot móvil basado en Rasperry Pi
\item Evaluación de la plataforma Nvidia Jetson Nano para aplicaciones de visión artificial
...
\item Comparative Study of Computer Vision Based Line Followers using Rasperry Pi and Jetson Nano 
\item Sistema de detección de somnolencia mediante inteligencia artificial en conductores de vehículos para alertar la ocurrencia de accidentes de tránsito 
\item Diseño de un sistema electrónico para detectar la somnolencia en automovilistas por medio de la actividad ocular
\item Sistema para la detección del estado de somnolencia en seres humanos, con reconocimiento de patrones. 
\item Sistema de Detección de Somnolencia
\item Desarrollar un prototipo de reconocimiento facial basado en Machine Learning para detectar estado de Somnolencia en conductores de una cooperativa de transporte
\item Sistema basado en la detección y notificación de somnolencia en conductores de autos
\item Detección de somnolencia para conducción sin accidentes
\item Diseño e implementación de un sistema de geolocalización en interiores para plataforma Android vía la red enterprise WLAN de la PUCP
\item Propuesta de un sistema de geolocalización y monitoreo vía GPS/GSM/GPRS aplicado a un pulsómetro para personas con enfermedades cardiovasculares
\item Influencia de un sistema de geolocalización en el control y monitoreo de vehículos con dispositivos GPS en una empresa logística
...
Partiendo de la propuesta de solución, se dividió el sistema en tres módulos principales: Módulo de Comunicaciones, Módulo Central de Procesamiento y Módulo de la Estación Base, figura \ref{fig:modulos1}. 
...
\begin{center}
  \includegraphics[scale=0.5]{imagenes/MapaCoberturaMexico.JPG}
...
\begin{center}
  \includegraphics[scale=0.7]{imagenes/CoberturaCDMX.JPG}
...
\begin{itemize}
\item Funcionamiento: Requiere una señal de entrada (una corriente alterna) para producir sonido. No tiene un oscilador interno.
\item Generación de sonido: Cuando se aplica una corriente eléctrica, el buzzer pasivo vibra mecánicamente para producir sonido.
\item Control: Limitado control sobre la frecuencia y la duración del sonido. La frecuencia está determinada principalmente por la corriente de entrada.
\item Niveles de Decibeles: Los buzzers pasivos tienden a tener niveles de decibeles más bajos en comparación con los activos.
\end{itemize}

\textbf{Buzzer Activo}

\begin{itemize}
\item Funcionamiento: Contiene un oscilador interno, por lo que no necesita una señal externa para generar sonido.
\item Generación de sonido: Al recibir un voltaje, el buzzer activo genera su propia frecuencia de oscilación, produciendo el sonido de manera independiente.
\item Control: Mayor control sobre la frecuencia y la duración del sonido, ya que se puede modular directamente mediante la entrada de voltaje.
\item Niveles de Decibeles: Los buzzers activos generalmente pueden alcanzar niveles de decibeles más altos en comparación con los pasivos.

\end{itemize}

El Buzzer Activo produce niveles de decibeles significativamente mayores en comparación con el Buzzer Pasivo. Esta característica implica que el Buzzer Activo genera un sonido más fuerte que el Buzzer Pasivo. Esta cualidad podría hacer que el Buzzer Activo sea preferible en situaciones donde se necesita despertar a un conductor, ya que un sonido más alto resulta más efectivo para este propósito. Además, el Buzzer Activo no requiere una señal externa para generar sonido.
...
\\
Para la transmisión del material multimedia a utilizar, se propone que el clip grabado tenga una profundidad de bits de mínimo 8 y una resolución de mínimo 960 x 540 píxeles, comúnmente conocido como QHD o "Quarter of High Definition" por sus siglas en inglés, todo esto en una secuencia propuesta de 30 fps.
\\
Tenemos que:
...
Estabilidad                         & \begin{tabular}[c]{@{}l@{}}La aplicación deberá ofrecer un buen \\ funcionamiento mientras se tenga \\ una conexión a internet\end{tabular}                                      &  \\ \cline{1-2}
\end{tabular}
...
\hline
 & \textbf{Cassandra } & \textbf{MongoDB } & \textbf{Redis } & \textbf{DynamoDB } \\ \hline
...
\begin{center}
  \includegraphics[scale=.8]{imagenes/respuesta}
...
El Módulo de Procesamiento Central entrará en modo de espera por los datos proporcionados por el Submódulo de Visión Artificial. En caso de que este último envíe una señal de alerta de somnolencia, el Módulo Central activará la alarma por medio de un buzzer.\\
...
\begin{center}
  \includegraphics[scale=.5]{imagenes/nanodim}
...
\begin{center}
  \includegraphics[scale=.45]{imagenes/waveshare}
...
\begin{center}
  \includegraphics[scale=.7]{imagenes/DiagramaFlujo_Vision.png}
...
De tal manera, cuanto mayor sea el valor del \emph{MOR}, mayor será la apertura de la boca.
\end{itemize}
...
\begin{center}
  \includegraphics[scale=.5]{imagenes/sec_perfil}
...
\begin{center}
  \includegraphics[scale=.28]{imagenes/profile}
...
\clearpage
\section{Capítulo V: Implementación}

\subsection{Módulo Central de Procesamiento}

\subsubsection{Instalación del entorno de desarrollo en la NVIDIA Jetson Nano}

El Jetson Nano Developer Kit utiliza una tarjeta microSD como dispositivo de arranque y almacenamiento principal. Por tanto, fue necesario instalar un entorno de desarrollo en la propia placa, para lo cual se requirió una tarjeta microSD de un mínimo recomendado de 32 GB, de acuerdo a la documentación de Nvidia \cite{Nvidia1}.\\
\\
Como primer paso, se descargó el \emph{JetPack SDK 4.6.3}, que es un archivo de imagen del sistema operativo específicamente diseñado y optimizado para ser utilizado en la placa de desarrollo NVIDIA Jetson Nano. La imagen incluye un sistema operativo Linux, controladores de hardware específicos para la Jetson Nano y una configuración predefinida. Para el presente proyecto, se utilizó la última versión disponible para la Jetson Nano 4GB, JetPack SDK 4.6.3 \cite{Jetpacksdk}.\\
...
\begin{center}
  \includegraphics[scale=0.15]{imagenes/JNconexiones.jpeg}
\captionof{figure}{Puertos de entrada para el Kit de desarrollo Jetson Nano.}
...
sudo pip3 install -U numpy==1.19.4 future mock keras_preprocessing 
keras_applications gast==0.2.1 protobuf pybind11 cython pkgconfig packaging
sudo pip3 install --extra-index-url https://developer.download.nvidia.com/
compute/redist/jp/v461 tensorflow
\end{verbatim}
...
\textbf{OpenCV con CUDA(Arquitectura de dispositivo unificado de cómputo)}
...
\subsubsection{Implementar algoritmo para la detección del rostro}

En este fragmento de código, se lleva a cabo la inicialización de la cámara y se configura la instancia para la captura de video. Adicionalmente, se realiza la inicialización del detector de rostros. La configuración de la cámara se realiza mediante la cadena gst\_str utilizando GStreamer, y posteriormente se establece la instancia de captura de video. Además, se emplea el detector de rostros proporcionado por la biblioteca Dlib, el cual desempeñará un papel fundamental en la detección y análisis de rostros en los fotogramas capturados por la cámara.\\

gst\_str contiene una cadena de configuración para la cámara utilizando GStreamer, una herramienta para construir flujos multimedia. Esta configuración está diseñada para trabajar con cámaras Nvidia Jetson, específicamente para el formato de memoria "NV12", el cual es un formato de píxeles comúnmente utilizado en dispositivos Nvidia y con una resolución de 1280x720 píxeles. Esto indica que cada fotograma capturado tendrá una dimensión de 1280 píxeles de ancho por 720 píxeles de alto.

\begin{center}
  \includegraphics[scale=0.6]{imagenes/DetecRostro1.JPG}
\captionof{figure}{Inicialización de cámara y detector.}
 \label{fig:FaceDetec} 
\end{center}  

Se implementó un bucle infinito para capturar continuamente frames de video desde una cámara. Para cada frame capturado, realiza las siguientes acciones:

\begin{enumerate}
    \item Calcula el tiempo actual y el número de fotogramas por segundo (FPS) con el objetivo de mostrar esta información en la esquina superior derecha del video.
    
    \item Convierte el frame a escala de grises para facilitar la detección de rostros.
    
    \item Utiliza un detector de rostros para identificar caras en el frame en escala de grises.
    
    \item Itera sobre las caras detectadas y dibuja un rectángulo verde alrededor de cada cara en el frame original.
\end{enumerate}
...
\begin{center}
  \includegraphics[scale=0.6]{imagenes/detecrostro2.JPG}
\captionof{figure}{Implementación del detector de rostro.}
 \label{fig:FaceDetec2} 
\end{center}  


\subsubsection{Implementar puntos de referencia en boca y ojos}
...
\begin{center}
  \includegraphics[scale=0.6]{imagenes/puntosreferencia.JPG}
\captionof{figure}{Puntos de referencia facial.}
 \label{fig:FaceDetec3} 
\end{center}  

\subsubsection{Implementar metrica MOR y medición de parpadeos}
...
\begin{itemize}
\item Función \texttt{cal\_yawn}:
Esta función toma los \emph{landmarks} faciales como entrada, identifica y extrae los \emph{landmarks} que representan la parte superior e inferior de los labios, calcula el promedio de las posiciones de estos landmarks superiores e inferiores, y finalmente, calcula la distancia euclidiana entre estos dos puntos promedio, proporcionando así una medida de la apertura de la boca.

\item Función \texttt{compute}
Esta función calcula la distancia euclidiana entre dos puntos dados, representados por las variables \texttt{ptA} y \texttt{ptB}.

\item Función blinked
 
La función \texttt{blinked} toma como entrada seis \emph{landmarks} correspondientes a los ojos, calcula las distancias entre puntos específicos para evaluar si el ojo está parpadeando, y retorna un valor numérico. La elección del umbral de EAR de 0.25 se basó en investigaciones anteriores \cite{lee2010} dónde se indica que los umbrales óptimos para clasificar un parpadeo son entre 0.2 y 0.3.

Devuelve:
\begin{itemize}
\item 2 si el parpadeo no es significativo.
\item 1 si el parpadeo es moderado.
\item 0 si el parpadeo es significativo.
\end{itemize}
\end{itemize}

\begin{center}
  \includegraphics[scale=0.7]{imagenes/funcionesdetec.JPG}
\captionof{figure}{Implementación de la metrica MOR y medición de parpadeos.}
 \label{fig:FaceDetec4} 
\end{center}  

\clearpage
\subsubsection{Implementar algoritmo para la detección somnolencia}
...
\textbf{Cálculo de la Apertura de la Boca:}

\begin{itemize}
  \item Utiliza la función \texttt{cal\_yawn} para calcular la distancia entre los landmarks asociados a la parte superior e inferior de los labios, proporcionando una medida de la apertura de la boca.
  \item Compara esta medida con un umbral (\texttt{yawn\_thresh}) para determinar si se ha superado, indicando la posibilidad de un bostezo.
  \item En base al promedio de la duración de un bostezo, que es entre 5 y 10 segundos\cite{teive2018}, se definió un umbral de 5 segundos de duración de apertura de boca para considerarse como un bostezo De la misma manera este estudio hace la clasificación de somnolencia cuando se presentan más de 1 bostezo por minuto.
  \item Registra el inicio y finalización de un bostezo, calculando su duración.
  
\end{itemize}

\begin{center}
  \includegraphics[scale=0.8]{imagenes/Somnolencia1.JPG}
\captionof{figure}{Cálculo de la Apertura de la Boca.}
 \label{fig:Somnolencia1} 
\end{center} 

\textbf{Detección de Parpadeos:}

\begin{itemize}
  \item Utiliza la función \texttt{blinked} para evaluar si los ojos están parpadeando.
  \item Registra el número de parpadeos significativos y realiza acciones específicas según el estado de alerta del sujeto (dormido, somnoliento o activo).

\end{itemize}

\begin{center}
  \includegraphics[scale=0.6]{imagenes/Somnolencia2.JPG}
\captionof{figure}{Detección de Parpadeo.}
 \label{fig:Somnolencia2} 
\end{center} 

\textbf{Alerta y Grabación de Video:}

\begin{itemize}
  \item Genera alertas en caso de detectar más de dos bostezos por minuto o el cierre de ojos por un intervalo de tiempo.
  \item Inicia la grabación de video en cuando somnolencia.
\end{itemize}
\begin{center}
  \includegraphics[scale=0.6]{imagenes/Somnolencia12.JPG}
\captionof{figure}{Detección de Parpadeo.}
 \label{fig:Somnolencia2} 
\end{center}


\textbf{Detección de Somnolencia}



\textbf{Activar una alarma cuando se detecte somnolencia}

\begin{itemize}
\item El siguiente script activa el zumbador pasivo al ser llamado por el script main al momendo de detectar somnolencia.
\end{itemize}

\begin{center}
  \includegraphics[scale=0.6]{imagenes/alarma_script.png}
\captionof{figure}{Script para la activación del buzzer}
 \label{fig:Somnolencia2} 
\end{center}
...
\textbf{Visualización en Tiempo Real:}

\begin{itemize}
  \item Dibuja un círculo en cada landmark facial detectado para visualizar los puntos de referencia en el rostro.
  \item Muestra el estado actual (dormido, somnoliento, activo) y la duración de los bostezos en el video.
\end{itemize}

\begin{center}
  \includegraphics[scale=0.6]{imagenes/Somnolencia3.JPG}
\captionof{figure}{Visualización en Tiempo Real.}
 \label{fig:Somnolencia2} 
\end{center} 

\textbf{Conteo de Bostezos:}

\begin{itemize}
  \item Realiza un seguimiento del conteo de bostezos por minuto.
  \item Muestra los fotogramas por segundo (FPS) en la esquina superior derecha del video.
\end{itemize}

\begin{center}
  \includegraphics[scale=0.6]{imagenes/Somnolencia4.JPG}
\captionof{figure}{Visualización de FPS.}
 \label{fig:Somnolencia2} 
\end{center} 


\subsubsection{Integración física de los periféricos y accesorios al Módulo Central de Procesamiento}
...
\subsubsection{Módulo 3G/4G LTE-Base Hat} \label{base_hat}

Para el presente proyecto, se hará uso del Base-Hat SIM7600G-H 4G para Jetson Nano el cual permite la conectividad de datos a través de redes móviles.\\

SIM7600G-H 4G para Jetson Nano es la versión global diseñada para mejorar las capacidades de conectividad de Jetson Nano. Este HAT (Hardware Attached on Top) es una placa de expansión que admite tecnologías 4G/3G/2G/GSM/GPRS/GNSS, basada en el módulo SIM7600E-H. Sus características incluyen un encabezado de extensión GPIO de 40 pines para una integración sin problemas con Jetson Nano, soporte para varios protocolos de comunicación como conexión telefónica, llamadas telefónicas, SMS, correo, TCP, UDP, DTMF, HTTP, FTP, etc.\\

La placa también incorpora posicionamiento de estación base GPS, BeiDou, Glonass y LBS, lo que la hace adecuada para proyectos que requieren información precisa de ubicación. Proporciona una interfaz USB incorporada para probar comandos AT y obtener datos de posicionamiento GPS. Además, el HAT cuenta con pines de control UART para una fácil conexión con placas principales como Arduino o STM32.\\

Otras características destacadas incluyen una ranura para tarjeta SIM compatible con tarjetas SIM de 1.8V/3V, un conector de audio de 3.5mm para llamadas telefónicas con soporte para auriculares y micrófono, y dos indicadores LED para monitorear el estado del dispositivo. El control se facilita a través de comandos AT siguiendo el conjunto de comandos 3GPP TS 27.007, 27.005 y V.25TER, la aplicación de comandos AT permite al usuario enviar instrucciones al módulo para realizar diversas operaciones y configuraciones. Además, el HAT admite características de la caja de herramientas de la aplicación SIM, como SAT Clase 3, GSM 11.14 Release 99 y USAT \cite{waveshare}. \\

\begin{center}
  \includegraphics[scale=0.7]{imagenes/hat}
\captionof{figure}{Módulo Base-Hat SIM7600G-H \cite{waveshare}.}
 \label{fig:hat} 
\end{center}

Utilizando la terminal del sistema operativo, se ingresarón los siguientes comandos en la siguiente figura.
...
\captionof{figure}{Prueba del puerto GPIO}
 \label{fig:gpioprueba} 
\end{center}
...
\subsubsection{Implemetación de la Geolocalización}
\textbf{Habilitar GPS y obtener datos de posición GPS desde la Jetson Nano}

Se conectó la antena incluida con el SIM7600 y se colocó el receptor en un lugar abierto. Se ejecutaron los siguientes comandos para probar el GPS.py el cual se descarga por defecto dentro de la carpeta \path{/Documents/SIM7600X_4G_for_JETSON_NANO/GPS/}.
...
Para obtener los datos de posición GPS, fue necesario interactuar con el módulo SIM7600X a través del programa en Python proporcionado al momento de realizar la instalación de \path{SIM7600X_4G_for_JETSON_NANO}:
...
El código en pytho nos permitió obtener las coordenadas: 

\begin{center}
  \includegraphics[scale=0.62]{imagenes/gpspy.png}
\captionof{figure}{Coordenadas obtenidas con gps.py}
 \label{fig:GPSpy1} 
\end{center} 

El código fue módificado de tal forma que solo se retornará las coordenadas en longitud y latitud cada determinado tiempo.\\
...
\begin{center}
  \includegraphics[scale=0.6]{imagenes/gps.png}
...
La primer configuración que se realizó, fue la habilitación y activación de la red 4G LTE en la Jetson Nano por medio de la interfaz wwan0 que nos permite conectarnos a internet por medio de la red celular \cite{waveshare}, se utilizó una SIM Telcel para adquirir GB y poder acceder a internet.\\

Se jecutaron los siguientes comandos para abrir minicom:

\begin{center}
  \includegraphics[scale=0.6]{imagenes/minicom}
\captionof{figure}{Comandos para abrir Minicom}
 \label{fig:gpio} 
\end{center}

Una vez ejecutado minicom se ejecutaron los siguientes comandos:
...
\begin{itemize}
\item AT+CNMP=38 (Configuración de Modo de Red Preferido): Configura el modo de red preferido. En este caso, se establece en 38, representa la preferencia por LTE (4G).
\item AT+CSQ (Calidad de Señal): Devuelve información sobre la calidad de la señal de la red celular.
\item AT+CREG? (Registro en la Red): Consulta el estado de registro en la red celular, proporcionando información sobre si el dispositivo está registrado en la red y el tipo de registro (doméstico, itinerante, etc.).
\item AT+COPS? (Selección de Operador): Consulta el operador actual, la información del operador será devuelta después de establecer una conexión normal.
\item AT+CPSI? (Información del Sistema de Posición Celular): Consulta la información del sistema del equipo usuario \cite{waveshare}.

\end{itemize}

Para hacer uso de las redes celulares y transmitir datos de manera inalámbrica, se requiere la instalación del controlador Simcom WWAN con permisos de superusuuario. Para ello, se descargó el controlador necesario con los siguientes comandos :
...
Se inserta el módulo simcom\_wwan en el kernel y se verifica que este cargado en el sistema con los siguiente comandos:

\begin{center}
  \includegraphics[scale=0.9]{imagenes/4glte4.JPG}
\captionof{figure}{Módulo simcom wwan.}
 \label{fig:4glte4} 
\end{center} 
...
\captionof{figure}{Asignación de IP.}
 \label{fig:4glte8} 
\end{center} 


\textbf{Instalación como servicio systemd}

Los siguientes scripts permiten instalar la conectividad 4G durante el arranque utilizando archivos de servicio systemd, un \emph{script preup} y un  \emph{script poststop} para automatizar los pasos anteriores \cite{simcomGit}.

\begin{itemize}
\item Se clona el repositorio
\begin{verbatim}
clone https://github.com/phillipdavidstearns/simcom_wwan-setup.git
\end{verbatim} 
\item Accedemos al repositorio 
\begin{verbatim}
...
sudo ./install.sh
\end{verbatim}
\item Para habilitarlo, ejecuta
\begin{verbatim}
sudo systemctl enable simcom_wwan@wwan0.service
\end{verbatim}
\item Para iniciar el servicio y la conectividad 4G LTE, ejecuta
\begin{verbatim}
sudo systemctl start simcom_wwan@wwan0.service
\end{verbatim}
\item Para verificar el estado del servicio:
\begin{verbatim}
...
Las rutas protedigas, están dentro de las etiquetas RequireAuth, mientras que las públicas, se encuentran dentro de las etiquetas Route.
...
Despues de haber realizado los pasos de la sección Backend, si ejecutamos el comando \emph{amplify status}, la consola de Amplify nos retornara el endpoint de GraphQL junto con AppSync correspondiente, el cuál se utilizará para realizar todas las operaciones con respecto al almacenamiento de datos
...
\section{Capítulo VI:Pruebas}

\subsection{Módulo Central de Procesamiento}

\subsubsection{Prueba de Detección de Somnolencia}

Se llevaron a cabo pruebas para la detección de somnolencia en distintos rostros, en algunos casos utilizando anteojos y prescindiendo de ellos, con el objetivo de observar la respuesta en un primer escenario. En este, se solicitó a los participantes que mantuvieran los ojos abiertos frente a la cámara, ubicados en una habitación con iluminación media, con la finalidad de confirmar que el sistema pudiera identificar el estado activo. 
\clearpage
\begin{itemize} 
 \item Prueba de detección del estado activo 1.

\begin{center}
  \includegraphics[scale=0.5]{imagenes/Prueba-EstadoActivoPersona1.png}
\captionof{figure}{Estado activo de la persona 1.}
 \label{fig:Prueba1} 
\end{center}  

\item Prueba de detección del estado activo 2.

\begin{center}
  \includegraphics[scale=0.5]{imagenes/Prueba-EstadoActivoPersona2.png}
\captionof{figure}{Estado activo de la persona 2.}
 \label{fig:Prueba1} 
\end{center}  

\item Prueba de detección del estado activo 3.

\begin{center}
  \includegraphics[scale=0.5]{imagenes/Prueba-EstadoActivoPersona3.png}
\captionof{figure}{Estado activo de la persona 3.}
 \label{fig:Prueba1} 
\end{center}  

\item Prueba de detección del estado activo 4.

\begin{center}
  \includegraphics[scale=0.5]{imagenes/Prueba-EstadoActivoPersona4.png}
\captionof{figure}{Estado activo de la persona 4.}
 \label{fig:Prueba1} 
\end{center}  

\end{itemize} 
 
Posteriormente, se les pidió simular un estado somnoliento cerrando los ojos para evaluar la capacidad del sistema de detectar el estado de somnolencia.

\begin{itemize} 
 \item Prueba de detección del estado somnoliento 1.

\begin{center}
  \includegraphics[scale=0.5]{imagenes/Prueba-EstadoSomnolenciaPersona1.png}
\captionof{figure}{Estado somnoliento de la persona 1.}
 \label{fig:Prueba1} 
\end{center}  

 \item Prueba de detección del estado somnoliento 2.

\begin{center}
  \includegraphics[scale=0.5]{imagenes/Prueba-EstadoSomnolientoPersona2.JPG}
\captionof{figure}{Estado somnoliento de la persona 2.}
 \label{fig:Prueba1} 
\end{center}  

 \item Prueba de detección del estado somnoliento 3.

\begin{center}
  \includegraphics[scale=0.5]{imagenes/Prueba-EstadoSomnolenciaPersona3.png}
\captionof{figure}{Estado somnoliento de la persona 3.}
 \label{fig:Prueba1} 
\end{center}  
...
Se llevaron a cabo pruebas dentro de un vehículo, considerando el uso de lentes, con el propósito de evaluar la detección de somnolencia en diferentes condiciones e ilumiación. Se evaluó la capacidad del sistema para detectar signos de somnolencia en situaciones de conducción, teniendo en cuenta la posible influencia de los anteojos en los resultados. 
 
 \begin{itemize} 
 \item Deteccion de un estado activo del conductor.

\begin{center}
  \includegraphics[scale=0.5]{imagenes/PruebaVehiculo1.png}
\captionof{figure}{Estado activo del conductor.}
 \label{fig:Prueba1} 
\end{center}  

 \item Deteccion de un estado activo del conductor con lentes.

\begin{center}
  \includegraphics[scale=0.5]{imagenes/PruebaVehiculo2.png}
\captionof{figure}{Estado activo del conductor con lentes.}
 \label{fig:Prueba2} 
\end{center}  

 \item Deteccion de un estado somnoliento del conductor.
 
 \begin{center}
  \includegraphics[scale=0.5]{imagenes/PruebaVehiculo3.png}
\captionof{figure}{Estado somnoliento del conductor.}
 \label{fig:Prueba3} 
\end{center}

\item Deteccion de un estado somnoliento del conductor con lentes.

 \begin{center}
  \includegraphics[scale=0.5]{imagenes/PruebaVehiculo4.png}
\captionof{figure}{Estado somnoliento del conductor con lentes.}
 \label{fig:Prueba4} 
\end{center}
 \end{itemize}


\subsubsection{Prueba de Alerta}
\begin{itemize}
\item Prueba de emisión de alerta ante la detección de síntomas de somnolencia. 

La figura \ref{fig:AlarmaCMD} presenta una impresión de la consola que emite un mensaje de alerta al detectar somnolencia. Este mensaje activa el buzzer durante un intervalo definido de 2 segundos y posteriormente lo desactiva.

\begin{center}
  \includegraphics[scale=0.45]{imagenes/Prueba-AlarmaConsola.jpeg}
\captionof{figure}{Activación y desactivación del buzzer.}
 \label{fig:AlarmaCMD} 
\end{center}

La figura \ref{fig:AlarmaJetson} muestra el buzzer sobre la carcasa conectado al sistema.

\begin{center}
  \includegraphics[scale=0.2]{imagenes/Prueba-AlarmaEnJN.jpeg}
\captionof{figure}{Buzzer del sistema.}
 \label{fig:AlarmaJetson} 
\end{center}
...
\subsubsection{Prueba de acceso a la aplicación a través del navegador:}
\begin{itemize}
    \item Verifica que la página de inicio de sesión es accesible por medio de \url{https://main.dcst1c83llut3.amplifyapp.com/login}
     
       \begin{center}
        \includegraphics[scale=.3]{imagenes/Prueba-url.jpeg}
        \captionof{figure}{Acceso a la página web desde el navegador}
        \label{fig:libraries} 
       \end{center} 
    
    \item Ingresa credenciales válidas y asegúrate de que se permita el acceso.
    
       \begin{center}
        \includegraphics[scale=.4]{imagenes/Prueba-login.jpeg} 
        \captionof{figure}{Acceso valido}
        \label{fig:libraries} 
       \end{center} 
    
    \item Intenta acceder con credenciales inválidas y confirma que se muestra un mensaje de error adecuado.
    
       \begin{center}
        \includegraphics[scale=.3]{imagenes/Prueba-RegistroNoValido.jpeg}
        \captionof{figure}{Acceso no valido}
        \label{fig:libraries} 
       \end{center}
    
\end{itemize}

\subsubsection{Prueba de registro de usuario:}
\begin{itemize}
    \item Confirmar que el formulario de registro es accesible.
    
      \begin{center}
       \includegraphics[scale=.6]{imagenes/Prueba-formulario0.JPG}
       \captionof{figure}{Acceso al formulario de registro de usuario.}
       \label{fig:libraries} 
      \end{center}
    
    \item Completar el formulario con datos válidos.
    
    \begin{center}
       \includegraphics[scale=.4]{imagenes/Prueba-formulario1.jpeg}
       \captionof{figure}{Formulario con datos validos.}
       \label{fig:libraries} 
      \end{center}
      
    \item Enviar el codigo de registro al correo proporcionado.
      
      \begin{center}
       \includegraphics[scale=.4]{imagenes/Prueba-formulario2.jpeg}
       \captionof{figure}{Código enviado al correo registrado.}
       \label{fig:libraries} 
      \end{center}
      
    \item Ingresar al correo y obtener el codigo de registro.
      
      \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-formulario3.jpeg}
       \captionof{figure}{Código recibido.}
       \label{fig:libraries} 
      \end{center}
      
     \item Confirmar codigo recibido.
     
     \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-formulario4.jpeg}
       \captionof{figure}{Confirmación del código.}
       \label{fig:libraries} 
      \end{center}
     
     \item Accesar como nuevo usuario registrado.
     
     \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-formulario5.jpeg}
       \captionof{figure}{Acceso a la página web.}
       \label{fig:libraries} 
      \end{center}
    
    \item Intenta registrarte con datos ya registrados.
    
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-formulario6.jpeg}
       \captionof{figure}{Registro no permitido.}
       \label{fig:libraries} 
      \end{center}
      
\end{itemize}

\subsubsection{Prueba de recuperación de contraseña:}
\begin{itemize}
    \item Verifica que la opción de recuperación de contraseña esté disponible.
    
    \begin{center}
       \includegraphics[scale=.4]{imagenes/Prueba-RecuperarContrasena.jpeg}
       \captionof{figure}{Enlace para recuperar contraseña.}
       \label{fig:libraries} 
      \end{center}

    \item Ingresar correo registrado.
    
    \begin{center}
       \includegraphics[scale=.4]{imagenes/Prueba-RecuperarContrasenaFormulario.jpeg}
       \captionof{figure}{Recuperación de contraseña por correo.}
       \label{fig:libraries} 
      \end{center}
      
    \item Verificar código recibido.
    
    \begin{center}
       \includegraphics[scale=.4]{imagenes/Prueba-verificarCodigo.jpeg}
       \captionof{figure}{Código recibido para recuperar contraseña.}
       \label{fig:libraries} 
      \end{center}
      
     \item Ingresar datos solicitados en el formulario.
     
     \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-IngresarCodigoyCambiarContrasena.jpeg}
       \captionof{figure}{Formulario para recuperar contraseña.}
       \label{fig:libraries} 
      \end{center}
      
\end{itemize}

\subsubsection{Prueba de visualización de incidencias:}
\begin{itemize}
    \item Visualizar el historial de incidencias al iniciar sesión.
    
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-Incidencias.jpeg}
       \captionof{figure}{Historial de incidencias.}
       \label{fig:libraries} 
     \end{center}
    
    \item Acceder a una incidencia específica y visualizar la disponibilidad de los datos: ID de incidencia, estatus (pendiente, confirmada o rechazada), nombre del conductor, video, fecha, botón para confirmar o rechazar, y mapa con el marcador de las coordenadas del momento en que se registro la incidencia.
    
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-VideoIncidencia.jpeg}
       \captionof{figure}{Datos disponibles de la incidencia.}
       \label{fig:libraries} 
     \end{center}
     
     \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-IncidenciaEspecifica.JPG}
       \captionof{figure}{Datos disponibles de la incidencia.}
       \label{fig:libraries} 
     \end{center}
...
\subsubsection{Prueba de visualización y reproducción de video de una incidencia:}
\begin{itemize}
    \item Acceder a una incidencia específica y visualizar el video de la incidencia.
      
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-VideoIncidencia.jpeg}
       \captionof{figure}{Video de incidencia.}
       \label{fig:libraries} 
     \end{center}
\end{itemize}

\subsubsection{Prueba de incidencia confirmada e incidencia rechazada:}

\begin{itemize}
    \item Visualizar la opción CONFIRMAR y RECHAZAR incidencia. Estas opciones permiten confirmar la incidencia cuando se visualice en el video un caso positivo de somnolecia o rechazar cuando se visualice en el video un caso falso de somnolecia.
    
    \begin{center}
       \includegraphics[scale=.8]{imagenes/Prueba-Botones.JPG}
       \captionof{figure}{Botones para confirmar o rechazar una incidencia.}
       \label{fig:libraries} 
     \end{center} 
    
    \item Realizar la confirmación y verificar que se refleje correctamente en la interfaz. 
    
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-Confirmar.JPG}
       \captionof{figure}{Incidencia confirmada.}
       \label{fig:libraries} 
     \end{center} 
       
    \item Descartar una incidencia y verificar que se actualice adecuadamente en la interfaz.
    
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-Rechazar.JPG}
       \captionof{figure}{Incidencia rechazada.}
       \label{fig:libraries} 
     \end{center} 
...
\subsubsection{Prueba de visualización del perfil del conductor:}
\begin{itemize}
    \item Visualizar la sección de conductores en la pagina principal.
    
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-Conductores.JPG}
       \captionof{figure}{Sección de conductores.}
       \label{fig:libraries} 
     \end{center} 
    
    \item Acceder a la sección de conductores y vizualizar los conductores registrados.
    
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-ConductoresVisualizacion.JPG}
       \captionof{figure}{Conductores registrados.}
       \label{fig:libraries} 
     \end{center}  
        
    \item Confirmar que el perfil se muestre correctamente con la información relevante.
    
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-ConductoresPerfil.JPG}
       \captionof{figure}{Perfil de conductor.}
       \label{fig:libraries} 
     \end{center}    
    
\end{itemize}

\subsubsection{Prueba para agregar conductor:}
\begin{itemize}   
    \item Llenar la información de un conductor no registrado.
    
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-AgregarConductor.jpeg}
       \captionof{figure}{Perfil de conductor.}
       \label{fig:libraries} 
     \end{center} 
    
    
    \item Verifica que los cambios se guarden correctamente y se reflejen en el perfil.  
    
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-VerificarAgregarConductor.jpeg}
       \captionof{figure}{Perfil de conductor.}
       \label{fig:libraries} 
     \end{center} 
...
\subsubsection{Prueba de visualización de la ubicación geográfica en tiempo real del conductor:}
\begin{itemize}
    
    \item Mostrar la ubicación en un mapa de las coordenadas registradas en tiempo real.
    
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-GPSTiempoReal.jpeg}
       \captionof{figure}{Ubicación en tiempo real del conductor.}
       \label{fig:libraries} 
     \end{center}  
    
\end{itemize}

\subsubsection{Prueba de editar conductor:}
\begin{itemize}
    \item Modifica la información de un conductor.
    
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-EditarCondutor.jpeg}
       \captionof{figure}{Ubicación en tiempo real del conductor.}
       \label{fig:libraries} 
     \end{center}  
    ...
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-VerificarEditarConductor.jpeg}
       \captionof{figure}{Ubicación en tiempo real del conductor.}
       \label{fig:libraries} 
     \end{center} 
...
\subsubsection{Prueba de eliminar conductor:}

\begin{itemize}
    \item Elimina la información de un conductor. 
    
    \begin{center}
       \includegraphics[scale=.3]{imagenes/Prueba-EliminarConductor.jpeg}
       \captionof{figure}{Confirmación para eliminar conductor.}
       \label{fig:libraries} 
     \end{center}  
        
    \item Verificar que los cambios se guarden correctamente y se reflejen en la sección de condutores.
     
\end{itemize}

Google Lighthouse es una herramienta de código abierto para mejorar la calidad de las páginas web. Puede realizar auditorías automatizadas para el rendimiento, la accesibilidad, las mejores prácticas de SEO entre otras. En una prueba de rendimiento web utilizando Lighthouse, se obtuvieron resultados destacados en accesibilidad (100/100), mejores prácticas (100/100) y SEO (100/100), indicando una estructura sólida, conformidad con las directrices de desarrollo establecidas y optimización para motores de búsqueda. 

    \begin{center}
       \includegraphics[scale=.3]{imagenes/Pruebas-Lighthouse.jpeg}
       \captionof{figure}{Confirmación para eliminar conductor.}
       \label{fig:libraries} 
     \end{center}  
...
\subsubsection{Prueba de Conectividad LTE:}

\begin{itemize}
  \item Prueba de conexión LTE para la transferencia de información por medio de red celular.
  
  \begin{center}
  \includegraphics[scale=0.6]{imagenes/4Gconexion.png}
\captionof{figure}{Interfaz de red 4G LTE wwan0 activa.}
 \label{fig:addstorage} 
\end{center} 
 
\end{itemize} 
\subsubsection{Prueba de Posicionamiento GPS:}
\begin{itemize}
  \item Prueba obtención de coordenadas de posicionamiento GPS.
  
  \begin{center}
  \includegraphics[scale=0.6]{imagenes/gps2.png}
	\captionof{figure}{Coordenadas en longitud y latitud.}
  \label{fig:addstorage} 
  \end{center} 
...
\begin{itemize}
  ...
  \item Prueba de visualización en tiempo real de la ubicación del conductor desde la aplicación web.

  \begin{center}
  \includegraphics[scale=0.6]{imagenes/evidencia.png}
	\captionof{figure}{Mapa y marcador de posicionamiento GPS en tiempo real.}
  \label{fig:addstorage} 
  \end{center} 

  \begin{center}
  \includegraphics[scale=0.9]{imagenes/logsposicion.png}
	\captionof{figure}{Logs de las coordenadas GPS en tiempo real.}
  \label{fig:addstorage} 
  \end{center}     
...
\clearpage
\section{Capítulo VII:Validación}

\subsection{Prueba de Funcionalidad Integral:}

Probar el sistema para validar su funcionalidad global en condiciones reales en base a los objetivos del sistema.
  
\subsubsection{Validación de Detección de Somnolencia y Alerta}

Para validar el funcionamiento del sistema de detección de somnolencia y asegurar el cumplimiento del primer objetivo específico, se llevó a cabo una prueba. En esta, se colocó el sistema cerca del conductor, orientando la cámara hacia él. Conectamos el sistema mediante un adaptador de corriente a la fuente de alimentación del microordenador Jetson Nano y ubicamos la antena del sistema cerca de la ventana del conductor para recopilar las coordenadas.

\begin{itemize}
 \item Sistema de detección de somnolencia instalado y conectado dentro del vehículo.
 
 \begin{center}
  \includegraphics[scale=0.25]{imagenes/Validacion-SistemaVistaFrontal.jpeg}
	\captionof{figure}{Vista lateral del sistema.}
  \label{fig:addstorage} 
  \end{center}   
  
  \begin{center}
  \includegraphics[scale=0.3]{imagenes/Validacion-SistemaVistaLateral.jpeg}
	\captionof{figure}{Vista frontal del sistema.}
  \label{fig:addstorage} 
  \end{center}   

 \end{itemize}

Se encendio el sistema y ejecutamos el archivo diseñado para la detección de somnolencia. El sistema capturó imágenes en tiempo real y evaluamos su capacidad para detectar correctamente el estado activo cuando el conductor estaba despierto, así como el estado somnoliento al manifestar signos como el cierre de ojos o bostezos constantes. En caso de detectar somnolencia, el sistema activa una alerta y envía la incidencia al sistema de administración.

 \begin{itemize}
 \item Estado activo donde el conductor se encuentra despierto.
 
 \begin{center}
  \includegraphics[scale=0.5]{imagenes/Validacion-EstadoActivo.png}
	\captionof{figure}{Estado activo del conductor.}
  \label{fig:addstorage} 
  \end{center}   
 
 \item Estado dormido donde el conductor cierre de los ojos por más de tres segundos.  
  
 
 \begin{center}
  \includegraphics[scale=0.9]{imagenes/Validacion-EstadoDormido.JPG}
	\captionof{figure}{Estado dormido del conductor.}
  \label{fig:addstorage} 
  \end{center} 
 
 \item Estado somnoliento donde el conductor presenta signos de somnolencia. 
 
 
 \begin{center}
  \includegraphics[scale=0.9]{imagenes/Validacion-EstadoSomnoliento.JPG}
	\captionof{figure}{Estado somnoliento del conductor.}
  \label{fig:addstorage} 
  \end{center}
  
   \item Aviso de Bostezo donde el conductor presenta más de dos bostezos. 
   
  \begin{center}
  \includegraphics[scale=0.9]{imagenes/Validacion-EstadoBostezo.JPG}
	\captionof{figure}{Estado somnoliento del conductor por bostezo.}
  \label{fig:addstorage} 
  \end{center}
  
  \item Alarma activa al presentarse el estado de somnolenica. 
  
  
  \item Envio de incidencia. 
 
 \end{itemize}
 

%\item Reproduce el video y asegúrate de que la reproducción sea fluida y sin problemas.

\subsubsection{Validación de la aplicación web}

Se ingreso a la aplicación correctamente y se ccedio a las incidencias registradas dado el ID del conductor.

\begin{center}
  \includegraphics[scale=0.5]{imagenes/Validacion-AccesoSistema.JPG}
	\captionof{figure}{Perfil del conductor.}
  \label{fig:addstorage} 
  \end{center}
\clearpage
Se verificó que las incidencias generadas por el estado de somnolencia y el estado dormido se recibieran correctamente en la aplicación web, con la información recopilada desde el sistema de detección de somnolencia. 

\begin{itemize}

\item Incidencia recibida y accedida desde la aplicación.

  \begin{center}
  \includegraphics[scale=0.5]{imagenes/Validacion-IncidenciaVistaApp1.JPG}
	\captionof{figure}{Vista de incidencia desde la aplicación web.}
  \label{fig:addstorage} 
  \end{center}
...
\item Incidencia recibida y accedida desde la aplicación.
  ...
  \begin{center}
  \includegraphics[scale=0.5]{imagenes/Validacion-IncidenciaVistaApp2.JPG}
	\captionof{figure}{Vista de incidencia desde la aplicación web.}
  \label{fig:addstorage} 
  \end{center}
...
\subsubsection{Validación de la Geolocalización en Tiempo Real y Conexión}

%Comprobar la actualización constante y precisa de la ubicación del conductor durante su desplazamiento.
%Verificar la consistencia en la precisión de la geolocalización en diferentes momentos y condiciones.

Desde la aplicación, se visualizó el mapa con un marcador de posicionamiento GPS en tiempo real. Se probó con un vehículo en movimiento en la Avenida Villa Panamericana, donde se puede observar su desplazamiento en las siguientes figuras:

  \begin{center}
  \includegraphics[scale=0.4]{imagenes/posicion1.png}
	\captionof{figure}{Mapa y marcador de posicionamiento GPS en tiempo real 1.}
  \label{fig:addstorage} 
  \end{center} 

  \begin{center}
  \includegraphics[scale=0.55]{imagenes/posicion2.png}
	\captionof{figure}{Mapa y marcador de posicionamiento GPS en tiempo real 2.}
  \label{fig:addstorage} 
  \end{center}   
  
    \begin{center}
  \includegraphics[scale=0.6]{imagenes/posicion3.png}
	\captionof{figure}{Mapa y marcador de posicionamiento GPS en tiempo real 3.}
  \label{fig:addstorage} 
  \end{center} 
  
    \begin{center}
  \includegraphics[scale=0.99]{imagenes/posicion4.png}
	\captionof{figure}{Mapa y marcador de posicionamiento GPS en tiempo real 2.}
  \label{fig:addstorage} 
  \end{center}
\clearpage
\section{Capitulo VIII: Resultados}

Los resultados fueron obtenidos mediante la evaluación de cuatro escenarios específicos en un entorno real, llevando a cabo las pruebas dentro de un vehículo estacionado y en movimiento. En cada escenario, el dispositivo fue colocado en el tablero del vehículo sin obstruir la vista frontal del conductor. La cámara se posicionó estratégicamente para capturar la totalidad del rostro del conductor durante las pruebas. Es esencial destacar que, debido a las limitaciones del sistema, no se logró detectar al conductor cuando este volteaba y la cámara ya no registraba las facciones del rostro.
Los escenarios evaluados fueron los siguientes:

\begin{enumerate}
    \item Sin el uso de lentes.
    \item Con el uso de lentes.
    \item Bajo la exposición directa a la luz solar dirigida hacia la cámara.
    \item En condiciones libres de reflejos provenientes de dicha luz directa.
\end{enumerate}
Este análisis exhaustivo se llevó a cabo utilizando una muestra completa de 39 incidencias, y los resultados se detallan en la tabla a continuación:



\begin{table}[htbp]
    \centering
    \caption{Tabla de de resultados}
    \tiny % Cambia el tamaño de la fuente a extra pequeña
    \begin{tabular}{|c|c|c|c|c|c|}
        \hline
        \multirow{2}{*}{Sin Lentes} & \multirow{2}{*}{Con Lentes} & \multirow{2}{*}{Sol Directo} & \multirow{2}{*}{Sol Indirecto} & \multirow{2}{*}{Estatus} \\
        & & & & \\
        \hline
        * & * & & & Confirmada \\
        * & * & & & Rechazada \\
...
\clearpage
A continuación se presenta un desglose de los porcentajes de los resultados anteriores.

\paragraph{Porcentaje de Incidencias Confirmadas}

\[
\text{Porcentaje de incidencias confirmadas: } \frac{\text{Total Confirmadas}}{\text{Total Incidencias}} \times 100 = \frac{29}{39} \times 100 \approx 74.36\%
\]

\paragraph{Porcentaje de Incidencias Rechazadas}

\[
\text{Porcentaje de incidencias rechazadas: } \frac{\text{Total Rechazadas}}{\text{Total Incidencias}} \times 100 = \frac{10}{39} \times 100 \approx 25.64\%
\]



\paragraph{Porcentaje de Casos Confirmados}

\begin{align*}
&\text{Porcentaje de casos confirmados con lentes:} & \frac{\text{13}}{\text{29}} \times 100 & \approx 44.83\% \\
&\text{Porcentaje de casos confirmados sin lentes:} & \frac{\text{16}}{\text{29}} \times 100 & \approx 55.17\% \\
&\text{Porcentaje de casos confirmados con luz directa:} & \frac{\text{14}}{\text{29}} \times 100 & \approx 48.28\% \\
&\text{Porcentaje de casos confirmados con luz indirecta:} & \frac{\text{14}}{\text{29}} \times 100 & \approx 48.28\%
\end{align*}

\paragraph{Porcentajes de Casos Rechazados}

\begin{align*}
&\text{Porcentaje de casos rechazados con lentes:} & \frac{\text{2}}{\text{10}} \times 100 & \approx 20\% \\
&\text{Porcentaje de casos rechazados sin lentes:} & \frac{\text{5}}{\text{10}} \times 100 & \approx 50\% \\
&\text{Porcentaje de casos rechazados con luz directa:} & \frac{\text{8}}{\text{10}} \times 100 & \approx 80\% \\
&\text{Porcentaje de casos rechazados con luz indirecta:} & \frac{\text{4}}{\text{10}} \times 100 & \approx 40\%
\end{align*}

\begin{itemize}
  \item El total de incidencias confirmadas fue de 29, representando aproximadamente el 74.36\% de la muestra total.
  \item Las incidencias rechazadas fueron 10, lo que constituye alrededor del 25.64\% de la muestra.
\item Cerca del 44.83\% de las incidencias confirmadas ocurrieron con el uso de lentes, mientras que el 55.17\% se registró sin lentes.
  \item Respecto a las condiciones de iluminación, aproximadamente el 48.28\% de las incidencias confirmadas ocurrieron tanto bajo luz directa como luz indirecta.
  \item El 50\% de las incidencias rechazadas se produjeron sin el uso de lentes, mientras que el 20\% se registró con lentes.
  \item En cuanto a las condiciones de iluminación, el 80\% de las incidencias rechazadas se presentaron bajo luz directa, y el 40\% bajo luz indirecta.
\end{itemize}


La cantidad total de incidencias confirmadas fue de 29, lo que representó aproximadamente el 74.36\% de la muestra total de 39 incidencias. Esto indica que la mayoría de las situaciones evaluadas fueron identificadas correctamente por el sistema. Por otro lado, se registraron 10 incidencias rechazadas, constituyendo alrededor del 25.64\% de la muestra. Estas son instancias en las que el sistema no pudo identificar correctamente la somnolencia del conductor.

En cuanto al uso de lentes, se observó que cerca del 44.83\% de las incidencias confirmadas ocurrieron con el uso de lentes, mientras que el 55.17\% se registró sin lentes. Esto indica que el sistema presenta un rendimiento razonable tanto con usuarios que utilizan lentes como con aquellos que no los usan.

En el caso de las incidencias rechazadas, el 50\% se produjo sin el uso de lentes, mientras que el 20\% se registró con lentes, debido a que la muestra del uso de lentes fue más alta.

En cuanto a las condiciones de iluminación en incidencias rechazadas, el 80\% se presentó bajo luz directa, y el 40\% bajo luz indirecta. Esto podría indicar que el sistema experimentó mayores desafíos en situaciones de iluminación directa de los rayos del sol. Estos resultados proporcionan una comprensión del rendimiento del sistema, destacando sus puntos fuertes y áreas de mejora. 

En el ámbito de la comunicación y transferencia de archivos, se implementó el módulo SIM7600H en la Jetson Nano, el cual incorpora GNSS para el posicionamiento GPS. Se logró obtener la ubicación en tiempo real de la Jetson Nano, lo cual se reflejó en la aplicación web en la sección destinada al seguimiento del conductor. No obstante, el sistema de geolocalización en tiempo real experimentó desconexiones con el sistema GPS, especialmente en condiciones climáticas adversas como cielos nublados, así como en lugares cerrados cómo túneles o dentro de edificios.


Con la ayuda de la aplicación \emph{Estado GNSS} podemos observar los satelites disponibles cerca de la ubicación actual:

  \begin{center}
  \includegraphics[scale=0.40]{imagenes/radar_gnss.jpeg}
	\captionof{figure}{Posición de Satelites}
  \label{fig:radar_gnss} 
  \end{center} 
  
Las posiciones de los satélites, junto con las condiciones meteorológicas y la presencia de edificaciones altas, son factores que explican las desconexiones experimentadas en el sistema de geolocalización en tiempo real.\\
Con respecto al proceso de desarrollo de la Estación Base, se integraron las herramientas suministradas por Amazon Amplify. La decisión se basó en la eficacia y versatilidad proporcionadas por Amplify Hosting, permitiendo simultáneamente una integración fluida con GitHub. Esto posibilitó que los cambios efectuados en el repositorio se reflejaran de manera automática en la aplicación web, agilizando el ciclo de desarrollo y asegurando una sincronización eficiente entre el código fuente.\\
Finalmente, el sistema posibilitó la detección de signos de somnolencia, emitiendo alertas al conductor. Además, permitió el seguimiento en tiempo real de la ubicación del conductor, facilitando así el monitoreo a través de la aplicación web. Esta aplicación desempeñó un papel crucial al administrar la información de los conductores y supervisar los informes de incidentes enviados desde el módulo central de procesamiento. La colaboración con la infraestructura de AWS desempeñó un papel significativo en la exitosa implementación del sistema.

\clearpage
\section{Capítulo IX: Conclusión y Aportaciones}

El proyecto se centró en desarrollar un sistema integral enfocado en la detección de síntomas de somnolencia y el registro de incidencias para proporcionar retroalimentación a los conductores. Este enfoque implicó la implementación de tecnologías avanzadas, como la Jetson Nano para la detección facial y el módulo SIM7600G para la comunicación y posicionamiento GPS.

A lo largo del proceso, se enfrentaron diversas implicaciones y complicaciones, desde la precisión en la detección de síntomas de somnolencia hasta la optimización de la comunicación entre la Jetson Nano y la aplicación web. Superar estos desafíos fue crucial para alcanzar los objetivos del sistema y asegurar su utilidad práctica.

Este sistema busca ser utilizado de diversas maneras. En el ámbito de la seguridad vial, proporciona una herramienta valiosa para abordar los riesgos asociados a la somnolencia del conductor. Además, las empresas de transporte podrían considerar la integración de esta tecnología para mejorar la calidad de sus conductores y la eficiencia de sus operaciones.

A nivel social, la implementación de este sistema puede contribuir a la reducción de accidentes de tráfico, ayudando a disminuir los costos asociados a los accidentes automovilísticos. También puede generar conciencia sobre la importancia de la vigilancia del estado del conductor durante los viajes, fomentando hábitos de conducción más seguros y promoviendo mejores hábitos de sueño.

Adicionalmente, el sistema de registros implementado puede servir como una herramienta valiosa para la recopilación de estadísticas e información relevante. Esta base de datos puede ser utilizada en futuros proyectos, proporcionando información valiosa para el diseño y desarrollo de sistemas similares. Al analizar la información a lo largo del tiempo, se podrían identificar tendencias en los patrones de somnolencia al volante.
...
\section{Capitulo X: Trabajo a futuro}

\begin{itemize}
\item Desarrollo de Análisis a Largo Plazo de Datos de Conducción:

Se propone la implementación de un sistema de análisis de datos a largo plazo que examine patrones de comportamiento de un conductor dadas las incidencias a lo largo del tiempo, brindando a conductores y empresas de transporte la capacidad de identificar tendencias y adoptar medidas preventivas de manera efectiva.

\item Personalización de Alertas Sonoras:

Se sugiere ampliar la diversidad de alertas sonoras disponibles y otorgar a los usuarios la capacidad de personalizar la alarma según sus preferencias individuales. Esta mejora podría incluir opciones como sonidos suaves, tonos personalizados o incluso mensajes de voz, proporcionando una experiencia más adaptable.

\item Definición de Zonas de Riesgo:

Se plantea la incorporación de la capacidad para que los usuarios definan zonas geográficas específicas como "zonas de riesgo", donde la probabilidad de somnolencia pueda ser más alta. La aplicación web podría proporcionar alertas y sugerencias específicas para estas áreas identificadas.

\item Módulos de Capacitación en Seguridad Vial:

Se sugiere la inclusión de módulos de capacitación en seguridad vial directamente a través de la aplicación web. Estos módulos podrían ofrecer consejos prácticos sobre cómo combatir la fatiga, la importancia de los descansos y las mejores prácticas para mantenerse alerta al conducir, fortaleciendo así la conciencia y educación en seguridad vial.

\item Gestión de Flotas en Tiempo Real:

se propone la integración de una función de gestión de flotas en tiempo real. Esta característica permitiría a los supervisores monitorear múltiples conductores simultáneamente, facilitando la toma de decisiones coordinadas y mejorando la gestión general.
