...
\begin{table}[htbp]
    \centering
    \begin{tabular}{|p{0.4\linewidth}|p{0.12\linewidth}|p{0.08\linewidth}|p{0.12\linewidth}|p{0.15\linewidth}|}
        \hline
        Proyecto & Detección de somnolencia & Portátil  & Monitoreo GPS en tiempo real & Sistema de admnistración \\
        \hline
