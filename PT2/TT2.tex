...
A Eduardo y Eneida,
cuyo amor, aliento y sacrificios han sido la fuerza impulsora que me ha permitido llegar hasta este momento. Gracias por ser mis guías, por creer en mí cuando dudaba y por ser la base sólida sobre la cual construí este logro.\\

A Carlos y María Luisa,

No puedo dejar de reconocer el papel crucial que han desempeñado en mi vida. Su amor y orientación han sido un regalo invaluable. Gracias por ser una extensión de mi familia, por compartir sabiduría y por contribuir a mi crecimiento personal y académico. Su influencia ha dejado una marca imborrable en mi corazón.

A mis asesores Rodolfo y Niels,

Quiero expresar mi gratitud por su dedicación y orientación a lo largo de este arduo pero gratificante viaje. Su experiencia, paciencia y compromiso han sido fundamentales para mi desarrollo académico. Gracias por brindarme su tiempo, conocimientos y por inspirarme a alcanzar estándares más altos. Este logro también es suyo.

A Maite Díaz,

Compartir este trayecto contigo ha sido un privilegio. Tus ideas, colaboración y apoyo han enriquecido enormemente mi experiencia. Aprecio sinceramente la dedicación y el esfuerzo que has aportado a este proyecto. Juntos hemos superado desafíos y celebrado triunfos, y estoy agradecido por tener a alguien tan talentosa y comprometida a mi lado.

\begin{flushright}
\textbf{Alan Eduardo Gamboa Del Angel}
\end{flushright}
...
La función \texttt{blinked} toma como entrada seis \emph{landmarks} correspondientes a los ojos, calcula las distancias entre puntos específicos para evaluar si el ojo está parpadeando, y retorna un valor numérico. Devuelve:
\begin{itemize}
...
Los resultados fueron obtenidos tras evaluar cuatro escenarios distintos: sin lentes, con lentes, bajo luz directa del sol dirigida hacia la cámara y finalmente sin reflejos de dicha luz directa. Este análisis se realizó utilizando una muestra total de 39 incidencias.


La siguiente tabla muestra el registro de dichos resultados por cada incidencia:
...
Estos resultados sugieren que las incidencias confirmadas predominan en comparación con las rechazadas, y la distribución varía significativamente según la presencia de lentes y las condiciones de luz.
\\
