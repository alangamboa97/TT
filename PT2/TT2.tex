...
Se obtuvó un sistema portátil mediante el uso de una Jetson Nano que posibilitó la detección del rostro, los ojos y la boca, seguida de la clasificación de la somnolencia. En este proceso, se consideraron la apertura de los ojos y la boca, así como la duración de estos estados. La implementación para el reconocimiento de signos de somnolencia se vio favorecida por la utilización de dlib para la detección facial y la evaluación de la relación entre el Movimiento de Apertura de Ojos (MOR) y el Estiramiento de Apertura de Boca (EOR) a través de puntos de referencia faciales.
\\
...
\section{Conclusión y Aportaciones}
