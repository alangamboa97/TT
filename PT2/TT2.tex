...
\subsubsection{Prueba de Detección Facial:}
\begin{itemize}
  \item Verificar la capacidad de \texttt{dlib} para la detección precisa de rostros, ojos y boca en diferentes condiciones de iluminación y fondos.
  \item Evaluar la velocidad y precisión de la detección en tiempo real.
\end{itemize}

\subsubsection{Prueba de Clasificación de Somnolencia:}
\begin{itemize}
