...
La importación de estás librerías permitiran diseñar las rutas del frontend que se utilizarán en el proyecto.

En el mismo archivo \emph{index.js} se creará una variable con el nombre de router que contendrá todas las rutas del fronted de la aplicación.

\begin{center}
  \includegraphics[scale=0.6]{imagenes/routes}
\captionof{figure}{Creación proyecto de react}
 \label{fig:MongoA} 
\end{center} 
...
\item \textbf{Path:} "/conductor/id \\ \textbf{Descripción:} Esta dirección mostrará el perfil del conductor de id correspondiente
...
Como primer paso, se necesita especificaf que estará utilizando el \emph{SDK} de Amazon Amplify:
