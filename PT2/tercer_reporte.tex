...
\section{Conexión de la aplicación web con el Módulo Central de Procesamiento}
...
\newpage
\section{Aplicar el algoritmo de detección con el módulo central de procesamiento}


\subsection{Objetivo}
Integrar el sistema e detección de somnolencia junto con la obtención de los datos de incidencia. 
...
\newpage
\section{Integración de los periféricos al Módulo Central de Procesamiento}
