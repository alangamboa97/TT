...
Además de mostrar en la aplicación web la ubicación en tiempo real.



\subsection{Descripción}
Para el sistema de geolocalización por parte de la aplicación web, se utilizará el servicio de \emph{Amazon Location Services}
