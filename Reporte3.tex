...
\begin{center}
  \includegraphics[scale=.6]{imagenes/EstructuraMongoDB}
\captionof{figure}{Estructura de datos en Mongo DB }
 \label{fig:EstructuraMongoDB}
\end{center}
...
\emph{Requerimientos Funcionales del Módulo de Estación Base}
...
\newpage
\emph{Requerimientos No Funcionales del Módulo de Estación Base}
...
\begin{center}
  \includegraphics[scale=.5]{imagenes/CasosdeusosMEB}
\captionof{figure}{Diagrama de Casos de Uso del Módulo de Estación Base }
 \label{fig:CasosdeusosMEB}
\end{center}


\begin{center}
  \includegraphics[scale=.5]{imagenes/DiagramadeactividadMEB}
...
\begin{center}
 \includegraphics[scale=.2]{imagenes/DiseñoMEB}
\captionof{figure}{D }
 \label{fig:DiseñoMEB}
\end{center}
