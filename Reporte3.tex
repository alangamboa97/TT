...
Con base en los requerimientos del sistema se plantea realizar el diseño de la arquitectura del Módulo de Estación Base, integrando el Módulo de Procesamiento Central y el Módulo de Comunicaciones. El cual hará énfasis en la organización y comunicación de los elementos que lo conforman.  

Los siguientes diagramas muestran las interacciones entre elementos que se involucran en cada requerimiento funcional.  
