...
\begin{tabular}{|l|l|l|}
\hline
\textbf{ Dígito }& \textbf{Número Binario} & \textbf{Línea} \\ \hline
1 & 0001 & 1 \\ \hline
2 & 0010 & 2\\ \hline
3 & 0011 & 3 \\ \hline
4 & 0100 & 4 \\ \hline
5 & 0101 & 5 \\ \hline
6 & 0110 & 6 \\ \hline
0 & 1010 & Finaliza llamda \\ \hline
Otro & XXXX & - \\ \hline
\end{tabular}
\captionof{figure}{Asignación del número a la línea telefónica}
\label{tabla:ANLT}
\end{table}
...
Para el diseño del circuito se utilizó Smartdraw el cual es una herramienta en línea para realizar esquemas eléctricos. A continuación se presenta el diseño del circuito implementado.\\\\


\begin{center}
  \includegraphics[scale=0.8]{imagenes/t1}
\captionof{figure}{Esquematico}
 \label{fig:Esquema1}
\end{center}

\begin{center}
  \includegraphics[scale=0.8]{imagenes/t2}
\captionof{figure}{Esquematico}
 \label{fig:Esquema2}
\end{center}
...
Pruebas del decodificador Módulo MT8870:\\

\begin{center}
  \includegraphics[scale=0.5]{imagenes/cuatro}
\captionof{figure}{Decodificador}
 \label{fig:decodificador}
\end{center}


Pruebas de conmutación a través de relevadores: \\
\begin{center}
  \includegraphics[scale=0.4]{imagenes/cinco}
...
void loop() {
  ...
  if((E1 == 1)&& (E2 == 0)&& (E3 == 0)&& (E4 == 0)){  //line 1
      digitalWrite(6,HIGH); 
      
  }
  else if((E1 == 0)&& (E2 == 1)&& (E3 == 0)&& (E4 == 0)){ //line 2
    digitalWrite(7,HIGH); 
            
  }
  else if((E1 == 1)&& (E2 == 1)&& (E3 == 0)&& (E4 == 0)){ //line 3
    digitalWrite(8,HIGH); 
     
  }
  else if((E1 == 0)&& (E2 == 0)&& (E3 == 1)&& (E4 == 0)){ //line 4
    digitalWrite(9,HIGH); 
      
  }
  else if((E1 == 1)&& (E2 == 0)&& (E3 == 1)&& (E4 == 0)){ //line 5
    digitalWrite(10,HIGH); 
    
  }
  else if((E1 == 0)&& (E2 == 1)&& (E3 == 1)&& (E4 == 0)){// line 6
    digitalWrite(11,HIGH); 
    
  }
  else if((E1 == 0)&& (E2 == 1)&& (E3 == 0) && (E4 == 1)){ //Finaliza la llamada con digito 0 
   digitalWrite(6,LOW); 
   digitalWrite(7,LOW); 
   digitalWrite(8,LOW); 
   digitalWrite(9,LOW);
...
Los resultados se muestran en las siguientes figuras, se puede observar el circuito junto con los aparatos telefónicos conectados en conjunto. 
\\ 
\begin{center}
  \includegraphics[scale=0.4]{imagenes/uno}
\captionof{figure}{Circuito Final}
 \label{fig:Resultadoimg1}
\end{center}

\begin{center}
  \includegraphics[scale=0.4]{imagenes/dos}
\captionof{figure}{Circuito Final}
 \label{fig:Resultadoimg2}
\end{center}

\begin{center}
  \includegraphics[scale=0.4]{imagenes/tres}
\captionof{figure}{Circuito Final}
 \label{fig:Resultadoimg3}
\end{center}
...
En conclusión no se pudo llegar al resultado esperado, sin embargo se logró identificar las partes que conforman los aparatos telefónicos, y los elementos esenciales dentro de la central telefónica incluyendo la parte de la marcación y señalización. Así mismo se conoció más a fondo y se puso en práctica la marcación por tonos y la conmutación para lograr una comunicación entre abonados.
