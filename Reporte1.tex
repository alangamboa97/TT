...
\fancyfoot[R]{\thepage}
\fancyfoot[L]{\footnotesize Reporte Parcial 2 }
...
\newpage
\section{Análisis del módulo Central de Procesamiento }
...
\hline
RF1 & Realizar la comunicación con el módulo de procesamiento de imágenes.\\
\hline
RF2 & Realizar la intercomunicación con los periféricos conectados al microprocesador. \\
\hline
RF3 & Clasificar los datos proporcionados por el módulo de procesamiento de imágenes. \\
\hline
RF4 & Realizar la comunicación del módulo de procesamiento de imágenes con el módulo de telemetría. \\
\hline
RF5 & Determinar el estado del conductor. \\
\hline
RF6 & Activar alarma. \\
\hline
RF7 & Establecer comunicación con la Estación Base.    \\
\hline
RF8 & Almacenar información en la unidad externa del almacenamiento en caso de que haya una pérdida de comunicación con la Estación Base. \\
\hline
\end{tabular}
\caption{Requerimientos Funcionales del Módulo Central de Procesamiento}
\label{tabla:Requerimientos Funcionales del Módulo Central de Procesamiento}
\end{center}
\end{table}
...
\hline
\end{tabular}
\caption{Requerimientos No Funcionales del Módulo Central de Procesamiento}
\label{tabla:Requerimientos No Funcionales del Módulo Central de Procesamiento}
\end{center}
\end{table}
