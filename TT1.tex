...
\subsubsection{\emph{Comparative Study of Computer Vision Based Line Followers using Rasperry Pi and Nano}}
...
\begin{tabular}{{|m{0.12\linewidth}|m{0.2\linewidth}|m{0.15\linewidth}|m{0.2\linewidth}|m{0.18\linewidth}|m{0.08\linewidth}|}}
\hline
\textbf{Nombre}& \textbf{CPU} & \textbf{RAM}  & \textbf{Almacenamiento} & \textbf{Alimentación}                                                 & \textbf{Precio} \\ \hline
Banana Pi BPI-F2  & ARM Cortex A9- MPCore Dual Core 1.2 Ghz & 2GB DDR3                                                & 8GB eMMC & 5V DC & \$2179 \\ \hline
ODRIOD-N2  & Amlogic S9XX hexa-core 1.7 Ghz & 4GB DDR4 & Chip SPI de 8MB Ranura para tarjetas MicroSD & 15V/5A  & \$5461 \\ \hline
Rasperry Pi 4B & 1.5 GHZ 64 bit QuadCore Cortex A-72 & 1GB, 2GB, 4GB, 8GB DDR4 & Ranura para tarjetas MicroSD & 5V vía USB-C o puerto GPIO& \$3956\\ \hline
Asus TinkerBoard 2S & Hexa Core A-72 2GHz & 2GB/4GB dual- channel LPDDR4 & 16GB eMMC + ranura para tarjetas MicroSD  & 12V-19V   & \$7169  \\ \hline
Jetson Nano & ARM A57 de cuatro núcleos & 4 GB de LPDDR4 de 64 bits & MicroSD & 5V/4A & \$3,743 \\ \hline
\end{tabular}
\end{table}
