...
\begin{itemize}
    ...
    \item \textbf{CNN} \tab[4.3cm] \emph{Convolutional Neural Network}
    \item \textbf{LTE-M} \tab[4cm] \emph{Long Term Evolution for Machines}
    \item \textbf{NB-IoT} \tab[3.7cm] \emph{Narrowband-Internet of Things}
    \item d
    \item e
    \item 
\end{itemize}
...
Como ya se mencionó en la sección \ref{solucion}, se hará uso de un microordenador para permitir que el sistema sea portátil y pueda funcionar dentro de un automóvil. A continuación se muestra un cuadro comparativo con los modelos de mayor aceptación en el mercado.


\begin{table}[H]
\centering
\begin{tabular}{{|m{0.12\linewidth}|m{0.2\linewidth}|m{0.16\linewidth}|m{0.16\linewidth}|m{0.13\linewidth}|m{0.1\linewidth}|}}
\textbf{Nombre}     & \textbf{CPU}                                                                        & \textbf{RAM}                                                           & \textbf{Almacenamiento}                                                                  & \textbf{Alimentación}                                                 & \textbf{Precio} \\ \hline
Banana Pi BPI-F2    & \begin{tabular}[c]{@{}l@{}}ARM Cortex\\ A9- MPCore\\ Dual Core 1.2 Ghz\end{tabular} & 2GB DDR3                                                               & 8GB eMMC                                                                                 & 5V DC                                                                 & \$2179          \\ \hline
ODRIOD-N2           & \begin{tabular}[c]{@{}l@{}}Amlogic\\ S9XX hexa-core 1.7 Ghz\end{tabular}            & 4GB DDR4                                                               & \begin{tabular}[c]{@{}l@{}}Chip SPI de 8MB\\ Ranura para tarjetas\\ MicroSD\end{tabular} & 15V/5A                                                                & \$5,461         \\ \hline
Rasperry Pi 4B      & \begin{tabular}[c]{@{}l@{}}1.5 GHZ 64 bit QuadCore\\ Cortex A-72\end{tabular}       & \begin{tabular}[c]{@{}l@{}}1GB, 2GB, 4GB,\\ 8GB DDR4\end{tabular}      & \begin{tabular}[c]{@{}l@{}}Ranura para tarjetas\\ MicroSD\end{tabular}                   & \begin{tabular}[c]{@{}l@{}}5V vía USB-C \\ o puerto GPIO\end{tabular} & \$3956          \\ \hline
Asus TinkerBoard 2S & Hexa Core A-72 2GHz                                                                 & \begin{tabular}[c]{@{}l@{}}2GB/4GB dual- channel\\ LPDDR4\end{tabular} & \begin{tabular}[c]{@{}l@{}}16GB eMMC + ranura\\ para tarjetas MicroSD\end{tabular}       & 12V-19V                                                               & \$7169          \\ \hline
\end{tabular}
\end{table}
...
\subsection{Análisis y elección de herramientas de programación}
...
\subsection{Análisis del Submódulo de Cobertura}
