...
\begin{itemize}
    ...
    \item \textbf{CPU} \tab[3.7cm] \emph{Central Processing Unit}
    \item \textbf{GPU} \tab[3.7cm] \emph{Graphical Processing Unit}
    \item 
\end{itemize}
...
Para la elección de la unidad de almacenamiento se consideró que la Jetson Nano requiere de una microSD de al menos 8GB de almacenamiento externo para la instalación del sistema operativo Raspbian oficial y tomando en cuenta que el tamaño compatible predeterminado más grande de Raspberry Pi es de 32GB, sin embargo, se puede formatear en caso de requerir capacidades más altas para que funcionen con las unidades.  
